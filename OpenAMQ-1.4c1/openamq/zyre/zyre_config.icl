<?xml?>
<!--
    *** GENERATED FROM zyre_config.opf BY opf_gen USING GSL/4 ***
...
<method name = "set restms_debug" template = "function">
    <argument name = "restms_debug" type = "Bool" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "restms_debug" return = "restms_debug">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "restms_debug" type = "Bool" />
    //
    if (self)
...
<method name = "set amqp_autorun" template = "function">
    <argument name = "amqp_autorun" type = "char *" />
    <inherit name = "wrlock" />
...
<method name = "amqp_autorun" return = "amqp_autorun">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_autorun" type = "char *" />
    //
    if (self)
...
<method name = "set amqp_hostname" template = "function">
    <argument name = "amqp_hostname" type = "char *" />
    <inherit name = "wrlock" />
...
<method name = "amqp_hostname" return = "amqp_hostname">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_hostname" type = "char *" />
    //
    if (self)
...
<method name = "set amqp_username" template = "function">
    <argument name = "amqp_username" type = "char *" />
    <inherit name = "wrlock" />
...
<method name = "amqp_username" return = "amqp_username">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_username" type = "char *" />
    //
    if (self)
...
<method name = "set amqp_password" template = "function">
    <argument name = "amqp_password" type = "char *" />
    <inherit name = "wrlock" />
...
<method name = "amqp_password" return = "amqp_password">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_password" type = "char *" />
    //
    if (self)
...
<method name = "set amqp_timeout" template = "function">
    <argument name = "amqp_timeout" type = "int" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "amqp_timeout" return = "amqp_timeout">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_timeout" type = "int" />
    //
    if (self)
...
<method name = "set amqp_trace" template = "function">
    <argument name = "amqp_trace" type = "int" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "amqp_trace" return = "amqp_trace">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_trace" type = "int" />
    //
    if (self)
...
<method name = "set amqp_debug" template = "function">
    <argument name = "amqp_debug" type = "Bool" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "amqp_debug" return = "amqp_debug">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "amqp_debug" type = "Bool" />
    //
    if (self)
