...
#define self_show_animation  amq_mgt_connection_show_animation
...
s_list_children (amq_mgt_connection_t *self, char *command, FILE *xml_data)
{
    ...
    if (!childname || ipr_str_prefixed ("connection_queue", childname)) {
        ...
        while (connection_queue) {
            ...
            || ipr_str_matches (connection_queue->exchange_name, pattern)
...
char *EMBED__amq_mgt_connection_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_mgt_connection_component  = "amq_mgt_connection ";
char *EMBED__amq_mgt_connection_version   = "1.0 ";
char *EMBED__amq_mgt_connection_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_mgt_connection_filename  = "amq_mgt_connection.icl ";
char *EMBED__amq_mgt_connection_builddate  = "2010/10/06 ";
char *EMBED__amq_mgt_connection_version_end  = "VeRsIoNeNd:ipc";
