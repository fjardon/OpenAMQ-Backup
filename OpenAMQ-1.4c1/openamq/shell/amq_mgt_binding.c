...
#define self_show_animation  amq_mgt_binding_show_animation
...
char *EMBED__amq_mgt_binding_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_mgt_binding_component    = "amq_mgt_binding ";
char *EMBED__amq_mgt_binding_version      = "1.0 ";
char *EMBED__amq_mgt_binding_copyright    = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_mgt_binding_filename     = "amq_mgt_binding.icl ";
char *EMBED__amq_mgt_binding_builddate    = "2010/10/06 ";
char *EMBED__amq_mgt_binding_version_end  = "VeRsIoNeNd:ipc";
