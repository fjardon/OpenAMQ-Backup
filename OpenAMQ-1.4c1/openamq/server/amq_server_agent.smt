...
<!--  Theory of operation
      ...
      amq_server_connection object. In the client, the Connection
      thread is created by the amq_client_connection object, and
      ...
      method through a call to amq_server_channel_error. In this
      ...
      An error raised synchronously by amq_server_method_execute
      ...
      method through a call to amq_server_connection_error.
...
<import class = "amq_server_method" />
...
<!--  Set per-connection trace level
      Called from amq_server_connection                                     -->
...
<!--  Called by amq_server_connection_error to signal an error processing a
...
<!--  Called by amq_server_channel_error to signal an error processing a
      method on a channel                                                   -->
...
<method name = "queue declare-ok">
    ...
    <argument name = "consumer_count"  type = "qbyte" />
    <possess>
...
<method name = "basic return">
    <argument name = "channel nbr" type = "dbyte" />
    <argument name = "content"     type = "amq_content_basic_t *" />
    <argument name = "reply_code"  type = "int" />
...
<method name = "basic deliver">
    ...
    <argument name = "redelivered"  type = "Bool" />
    <argument name = "exchange"    type = "char *" />
    <argument name = "routing_key"  type = "char *" />
    <!-- Tells the connection what to do when the content has been sent -->
    <argument name = "callback"    type = "void *" />
...
<method name = "basic get-empty">
    <argument name = "channel nbr" type = "dbyte" />
    <argument name = "sender_id"   type = "char *" />
    <possess>
...
<thread
    ...
    <state name = "connection active">
        ...
        <method name = "queue unbind-ok">
            <action name = "send queue unbind-ok" />
        </method>
        <method name = "basic qos-ok">
            <action name = "send basic qos-ok" />
        </method>
        <method name = "basic consume-ok">
