...
#define self_show_animation  amq_queue_connection_show_animation
...
/*  -------------------------------------------------------------------------
    amq_queue_connection_show_animation
...
char *EMBED__amq_queue_connection_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_queue_connection_component  = "amq_queue_connection ";
char *EMBED__amq_queue_connection_version  = "1.0 ";
char *EMBED__amq_queue_connection_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_queue_connection_filename  = "amq_queue_connection.icl ";
char *EMBED__amq_queue_connection_builddate  = "2010/10/06 ";
char *EMBED__amq_queue_connection_version_end  = "VeRsIoNeNd:ipc";
