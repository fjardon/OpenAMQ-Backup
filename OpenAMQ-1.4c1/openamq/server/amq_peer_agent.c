/*---------------------------------------------------------------------------
    amq_peer_agent.c - functions for amq_peer_agent.
...
#define channel_open_m ((amq_peer_agent_channel_open_t *) thread->method->data)

#define channel_close_m ((amq_peer_agent_channel_close_t *) thread->method->data)

#define channel_flow_m ((amq_peer_agent_channel_flow_t *) thread->method->data)

#define channel_flow_ok_m ((amq_peer_agent_channel_flow_ok_t *) thread->method->data)

#define exchange_declare_m ((amq_peer_agent_exchange_declare_t *) thread->method->data)

#define exchange_delete_m ((amq_peer_agent_exchange_delete_t *) thread->method->data)

#define queue_declare_m ((amq_peer_agent_queue_declare_t *) thread->method->data)

#define queue_bind_m ((amq_peer_agent_queue_bind_t *) thread->method->data)

#define queue_purge_m ((amq_peer_agent_queue_purge_t *) thread->method->data)

#define queue_delete_m ((amq_peer_agent_queue_delete_t *) thread->method->data)

#define queue_unbind_m ((amq_peer_agent_queue_unbind_t *) thread->method->data)

#define basic_qos_m ((amq_peer_agent_basic_qos_t *) thread->method->data)

#define basic_consume_m ((amq_peer_agent_basic_consume_t *) thread->method->data)

#define basic_cancel_m ((amq_peer_agent_basic_cancel_t *) thread->method->data)

#define basic_publish_m ((amq_peer_agent_basic_publish_t *) thread->method->data)

#define basic_get_m ((amq_peer_agent_basic_get_t *) thread->method->data)

#define basic_ack_m ((amq_peer_agent_basic_ack_t *) thread->method->data)

#define basic_reject_m ((amq_peer_agent_basic_reject_t *) thread->method->data)

#define direct_put_m ((amq_peer_agent_direct_put_t *) thread->method->data)

#define direct_get_m ((amq_peer_agent_direct_get_t *) thread->method->data)

#define restms_pipe_create_m ((amq_peer_agent_restms_pipe_create_t *) thread->method->data)

#define restms_pipe_delete_m ((amq_peer_agent_restms_pipe_delete_t *) thread->method->data)

#define restms_feed_create_m ((amq_peer_agent_restms_feed_create_t *) thread->method->data)

#define restms_feed_delete_m ((amq_peer_agent_restms_feed_delete_t *) thread->method->data)

#define restms_join_create_m ((amq_peer_agent_restms_join_create_t *) thread->method->data)

#define restms_join_delete_m ((amq_peer_agent_restms_join_delete_t *) thread->method->data)

#define push_m ((amq_peer_agent_push_t *) thread->method->data)
...
#define amq_peer_agent_agent_name                  "Amq-Peer-Agent"
...
amq_peer_agent_channel_open_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_peer_agent_channel_close_t;
...
amq_peer_agent_channel_flow_ok_t;
...
amq_peer_agent_exchange_declare_t;
...
amq_peer_agent_exchange_delete_t;
...
amq_peer_agent_queue_declare_t;
...
amq_peer_agent_basic_consume_t;
...
amq_peer_agent_basic_publish_t;
...
amq_peer_agent_restms_pipe_create_t;
...
amq_peer_agent_restms_pipe_delete_t;
...
amq_peer_agent_restms_feed_create_t;
...
amq_peer_agent_restms_feed_delete_t;
...
amq_peer_agent_restms_join_create_t;
...
amq_peer_agent_restms_join_delete_t;
...
} amq_peer_agent_connection_context_t;
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_PEER_AGENT)           ||  defined (BASE_TRACE)  || defined (BASE_TRACE_AMQ_PEER_AGENT)   ||  defined (AMQ_PEER_AGENT_TRACE))
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_PEER_AGENT))
static Bool
    s_animate = FALSE;
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SET_NO_CONNECTION_ERROR))
static icl_stats_t *s_amq_peer_agent_set_no_connection_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_SETUP_TIMER))
static icl_stats_t *s_amq_peer_agent_start_setup_timer_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CONNECT_TO_SERVER))
static icl_stats_t *s_amq_peer_agent_connect_to_server_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_PROTOCOL_HEADER))
static icl_stats_t *s_amq_peer_agent_send_protocol_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_FRAME_HEADER))
static icl_stats_t *s_amq_peer_agent_read_frame_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_PROTOCOL_HEADER))
static icl_stats_t *s_amq_peer_agent_check_protocol_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_PROTOCOL_VERSION))
static icl_stats_t *s_amq_peer_agent_read_protocol_version_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_VERSION_MISMATCH))
static icl_stats_t *s_amq_peer_agent_report_version_mismatch_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_BAD_PROTOCOL))
static icl_stats_t *s_amq_peer_agent_report_bad_protocol_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_START))
static icl_stats_t *s_amq_peer_agent_execute_connection_start_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_INPUT_THREAD))
static icl_stats_t *s_amq_peer_agent_start_input_thread_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_START_OK))
static icl_stats_t *s_amq_peer_agent_send_connection_start_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_TUNE_OK))
static icl_stats_t *s_amq_peer_agent_send_connection_tune_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_HEARTBEAT_THREAD))
static icl_stats_t *s_amq_peer_agent_start_heartbeat_thread_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_HEARTBEAT_TIMER))
static icl_stats_t *s_amq_peer_agent_start_heartbeat_timer_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CANCEL_SETUP_TIMER))
static icl_stats_t *s_amq_peer_agent_cancel_setup_timer_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_OPEN))
static icl_stats_t *s_amq_peer_agent_send_connection_open_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_FLOW))
static icl_stats_t *s_amq_peer_agent_send_channel_flow_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_FLOW_OK))
static icl_stats_t *s_amq_peer_agent_send_channel_flow_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_EXCHANGE_DECLARE))
static icl_stats_t *s_amq_peer_agent_send_exchange_declare_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_EXCHANGE_DELETE))
static icl_stats_t *s_amq_peer_agent_send_exchange_delete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_DECLARE))
static icl_stats_t *s_amq_peer_agent_send_queue_declare_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_BIND))
static icl_stats_t *s_amq_peer_agent_send_queue_bind_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_PURGE))
static icl_stats_t *s_amq_peer_agent_send_queue_purge_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_DELETE))
static icl_stats_t *s_amq_peer_agent_send_queue_delete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_UNBIND))
static icl_stats_t *s_amq_peer_agent_send_queue_unbind_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_QOS))
static icl_stats_t *s_amq_peer_agent_send_basic_qos_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_CONSUME))
static icl_stats_t *s_amq_peer_agent_send_basic_consume_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_CANCEL))
static icl_stats_t *s_amq_peer_agent_send_basic_cancel_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_PUBLISH))
static icl_stats_t *s_amq_peer_agent_send_basic_publish_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_GET))
static icl_stats_t *s_amq_peer_agent_send_basic_get_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_ACK))
static icl_stats_t *s_amq_peer_agent_send_basic_ack_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_REJECT))
static icl_stats_t *s_amq_peer_agent_send_basic_reject_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_DIRECT_PUT))
static icl_stats_t *s_amq_peer_agent_send_direct_put_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_DIRECT_GET))
static icl_stats_t *s_amq_peer_agent_send_direct_get_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_PIPE_CREATE))
static icl_stats_t *s_amq_peer_agent_send_restms_pipe_create_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_PIPE_DELETE))
static icl_stats_t *s_amq_peer_agent_send_restms_pipe_delete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_FEED_CREATE))
static icl_stats_t *s_amq_peer_agent_send_restms_feed_create_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_FEED_DELETE))
static icl_stats_t *s_amq_peer_agent_send_restms_feed_delete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_JOIN_CREATE))
static icl_stats_t *s_amq_peer_agent_send_restms_join_create_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_JOIN_DELETE))
static icl_stats_t *s_amq_peer_agent_send_restms_join_delete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_OPEN))
static icl_stats_t *s_amq_peer_agent_send_channel_open_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_CLOSE))
static icl_stats_t *s_amq_peer_agent_send_channel_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_CLOSE_OK))
static icl_stats_t *s_amq_peer_agent_send_channel_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_PUSH_METHOD_TO_SERVER))
static icl_stats_t *s_amq_peer_agent_push_method_to_server_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONTENT_HEADER))
static icl_stats_t *s_amq_peer_agent_send_content_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONTENT_BODY_FRAME))
static icl_stats_t *s_amq_peer_agent_send_content_body_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SHUT_DOWN_SLAVE_THREADS))
static icl_stats_t *s_amq_peer_agent_shut_down_slave_threads_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SMT_ERROR))
static icl_stats_t *s_amq_peer_agent_report_smt_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_CLOSE))
static icl_stats_t *s_amq_peer_agent_send_connection_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_CLOSE))
static icl_stats_t *s_amq_peer_agent_execute_connection_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_CLOSE_OK))
static icl_stats_t *s_amq_peer_agent_send_connection_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_FLUSH_THE_CONNECTION))
static icl_stats_t *s_amq_peer_agent_flush_the_connection_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SOCKET_ERROR))
static icl_stats_t *s_amq_peer_agent_report_socket_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_CONNECT_ERROR))
static icl_stats_t *s_amq_peer_agent_report_connect_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SOCKET_TIMEOUT))
static icl_stats_t *s_amq_peer_agent_report_socket_timeout_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_CONNECT_TIMEOUT))
static icl_stats_t *s_amq_peer_agent_report_connect_timeout_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_HEARTBEAT_FRAME))
static icl_stats_t *s_amq_peer_agent_send_heartbeat_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_FRAME_PAYLOAD))
static icl_stats_t *s_amq_peer_agent_read_frame_payload_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_FRAME_FORMAT))
static icl_stats_t *s_amq_peer_agent_check_frame_format_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DECODE_METHOD))
static icl_stats_t *s_amq_peer_agent_decode_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_METHOD_CLASS))
static icl_stats_t *s_amq_peer_agent_check_method_class_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_CONNECTION_METHOD))
static icl_stats_t *s_amq_peer_agent_check_connection_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_CHANNEL_METHOD))
static icl_stats_t *s_amq_peer_agent_check_channel_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_FUNCTIONAL_METHOD))
static icl_stats_t *s_amq_peer_agent_execute_functional_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_TUNE))
static icl_stats_t *s_amq_peer_agent_execute_connection_tune_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_TUNE))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_tune_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_OPEN_OK))
static icl_stats_t *s_amq_peer_agent_execute_connection_open_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_OPEN_OK))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_open_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_PASSIVE_CLOSE))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_passive_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_CLOSE_OK))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_OPEN_OK))
static icl_stats_t *s_amq_peer_agent_execute_channel_open_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_CLOSE))
static icl_stats_t *s_amq_peer_agent_execute_channel_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_CLOSE_OK))
static icl_stats_t *s_amq_peer_agent_execute_channel_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_FLOW))
static icl_stats_t *s_amq_peer_agent_execute_channel_flow_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_FLOW_OK))
static icl_stats_t *s_amq_peer_agent_execute_channel_flow_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONTENT_BASIC_HEADER))
static icl_stats_t *s_amq_peer_agent_expect_content_basic_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_IF_BASIC_BODY_COMPLETE))
static icl_stats_t *s_amq_peer_agent_check_if_basic_body_complete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONTENT_BASIC_BODY))
static icl_stats_t *s_amq_peer_agent_expect_content_basic_body_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_EXCEPTION_METHOD))
static icl_stats_t *s_amq_peer_agent_expect_exception_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_EXCEPTION))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_exception_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_ERROR))
static icl_stats_t *s_amq_peer_agent_notify_connection_of_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_METHOD_FRAME))
static icl_stats_t *s_amq_peer_agent_expect_method_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONNECTION_CLOSE_OK))
static icl_stats_t *s_amq_peer_agent_expect_connection_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_WAIT_FOR_HEARTBEAT_INTERVAL))
static icl_stats_t *s_amq_peer_agent_wait_for_heartbeat_interval_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_PEER_LIVENESS))
static icl_stats_t *s_amq_peer_agent_check_peer_liveness_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_PEER_SLOWING))
static icl_stats_t *s_amq_peer_agent_report_peer_slowing_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SHUT_DOWN_AGENT))
static icl_stats_t *s_amq_peer_agent_shut_down_agent_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_PEER_STOPPED))
static icl_stats_t *s_amq_peer_agent_report_peer_stopped_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_SEND_CONTENT_BODY_IF_ANY_START))
static icl_stats_t *s_amq_peer_agent_dialog_call_send_content_body_if_any_start_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_RETURN))
static icl_stats_t *s_amq_peer_agent_dialog_return_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_PASSIVE_CLOSE))
static icl_stats_t *s_amq_peer_agent_dialog_call_close_the_connection_passive_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_48))
static icl_stats_t *s_amq_peer_agent_unnamed_48_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_49))
static icl_stats_t *s_amq_peer_agent_unnamed_49_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_50))
static icl_stats_t *s_amq_peer_agent_unnamed_50_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_ACTIVE_CLOSE))
static icl_stats_t *s_amq_peer_agent_dialog_call_close_the_connection_active_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_READ_METHOD_READ_METHOD))
static icl_stats_t *s_amq_peer_agent_dialog_call_read_method_read_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CONNECTION_CLOSING_CLOSING))
static icl_stats_t *s_amq_peer_agent_dialog_call_connection_closing_closing_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_READ_BASIC_CONTENT_HEADER))
static icl_stats_t *s_amq_peer_agent_dialog_call_read_basic_content_header_stats = NULL;
#endif
...
static int    amq_peer_agent_manager          (smt_thread_t **thread);
static int    amq_peer_agent_catcher          (smt_thread_t *thread);
static int    amq_peer_agent_connection_destroy  (smt_thread_t *thread);
static int    amq_peer_agent_input_destroy    (smt_thread_t *thread);
static int    amq_peer_agent_heartbeat_destroy  (smt_thread_t *thread);
...
#endif
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_PEER_AGENT)             ||  defined (AMQ_PEER_AGENT_TRACE))
...
static int
amq_peer_agent_channel_open_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_peer_agent_channel_open_destructor (void *data);
static int
amq_peer_agent_channel_close_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_peer_agent_channel_close_destructor (void *data);
static int
amq_peer_agent_channel_flow_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    Bool           active);
int
amq_peer_agent_channel_flow_destructor (void *data);
static int
amq_peer_agent_channel_flow_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    Bool           active);
int
amq_peer_agent_channel_flow_ok_destructor (void *data);
static int
amq_peer_agent_exchange_declare_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    icl_longstr_t *  arguments);
int
amq_peer_agent_exchange_declare_destructor (void *data);
static int
amq_peer_agent_exchange_delete_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    Bool           nowait);
int
amq_peer_agent_exchange_delete_destructor (void *data);
static int
amq_peer_agent_queue_declare_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    icl_longstr_t *  arguments);
int
amq_peer_agent_queue_declare_destructor (void *data);
static int
amq_peer_agent_queue_bind_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    icl_longstr_t *  arguments);
int
amq_peer_agent_queue_bind_destructor (void *data);
static int
amq_peer_agent_queue_purge_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    Bool           nowait);
int
amq_peer_agent_queue_purge_destructor (void *data);
static int
amq_peer_agent_queue_delete_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    Bool           nowait);
int
amq_peer_agent_queue_delete_destructor (void *data);
static int
amq_peer_agent_queue_unbind_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    icl_longstr_t *  arguments);
int
amq_peer_agent_queue_unbind_destructor (void *data);
static int
amq_peer_agent_basic_qos_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    qbyte          prefetch_size,
    ...
    Bool           global);
int
amq_peer_agent_basic_qos_destructor (void *data);
static int
amq_peer_agent_basic_consume_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    icl_longstr_t *  arguments);
int
amq_peer_agent_basic_consume_destructor (void *data);
static int
amq_peer_agent_basic_cancel_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         consumer_tag,
    Bool           nowait);
int
amq_peer_agent_basic_cancel_destructor (void *data);
static int
amq_peer_agent_basic_publish_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_content_basic_t *  content,
    ...
    Bool           immediate);
int
amq_peer_agent_basic_publish_destructor (void *data);
static int
amq_peer_agent_basic_get_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int            ticket,
    ...
    Bool           no_ack);
int
amq_peer_agent_basic_get_destructor (void *data);
static int
amq_peer_agent_basic_ack_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int64_t        delivery_tag,
    Bool           multiple);
int
amq_peer_agent_basic_ack_destructor (void *data);
static int
amq_peer_agent_basic_reject_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    int64_t        delivery_tag,
    Bool           requeue);
int
amq_peer_agent_basic_reject_destructor (void *data);
static int
amq_peer_agent_direct_put_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         sink);
int
amq_peer_agent_direct_put_destructor (void *data);
static int
amq_peer_agent_direct_get_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         feed);
int
amq_peer_agent_direct_get_destructor (void *data);
static int
amq_peer_agent_restms_pipe_create_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         pipe_type,
    char *         pipe_name);
int
amq_peer_agent_restms_pipe_create_destructor (void *data);
static int
amq_peer_agent_restms_pipe_delete_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         pipe_name);
int
amq_peer_agent_restms_pipe_delete_destructor (void *data);
static int
amq_peer_agent_restms_feed_create_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         feed_type,
    char *         feed_name);
int
amq_peer_agent_restms_feed_create_destructor (void *data);
static int
amq_peer_agent_restms_feed_delete_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         feed_name);
int
amq_peer_agent_restms_feed_delete_destructor (void *data);
static int
amq_peer_agent_restms_join_create_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         pipe_name,
    ...
    char *         address);
int
amq_peer_agent_restms_join_create_destructor (void *data);
static int
amq_peer_agent_restms_join_delete_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         pipe_name,
    ...
    char *         address);
int
amq_peer_agent_restms_join_delete_destructor (void *data);
static int
amq_peer_agent_push_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_peer_method_t *  method);
int
amq_peer_agent_push_destructor (void *data);
    ...
    dbyte          channel_nbr)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          amq_peer_agent_channel_open_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_peer_agent_channel_open_t *) data)-> channel_nbr;
    ...
    dbyte          channel_nbr)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_channel_close_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_peer_agent_channel_close_t *) data)-> channel_nbr;
    ...
    Bool           active)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_channel_flow_destructor);
...
Bool active;
    ...
    channel_nbr = ((amq_peer_agent_channel_flow_t *) data)-> channel_nbr;
    active = ((amq_peer_agent_channel_flow_t *) data)-> active;
    ...
    Bool           active)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_channel_flow_ok_destructor);
...
Bool active;
    ...
    channel_nbr = ((amq_peer_agent_channel_flow_ok_t *) data)-> channel_nbr;
    active = ((amq_peer_agent_channel_flow_ok_t *) data)-> active;
    ...
    icl_longstr_t *  arguments)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_exchange_declare_destructor);
...
icl_longstr_t * arguments;
    ...
    channel_nbr = ((amq_peer_agent_exchange_declare_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_exchange_declare_t *) data)-> ticket;
    exchange = ((amq_peer_agent_exchange_declare_t *) data)-> exchange;
    type = ((amq_peer_agent_exchange_declare_t *) data)-> type;
    passive = ((amq_peer_agent_exchange_declare_t *) data)-> passive;
    durable = ((amq_peer_agent_exchange_declare_t *) data)-> durable;
    auto_delete = ((amq_peer_agent_exchange_declare_t *) data)-> auto_delete;
    internal = ((amq_peer_agent_exchange_declare_t *) data)-> internal;
    nowait = ((amq_peer_agent_exchange_declare_t *) data)-> nowait;
    arguments = ((amq_peer_agent_exchange_declare_t *) data)-> arguments;
    ...
    Bool           nowait)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_exchange_delete_destructor);
...
Bool nowait;
    ...
    channel_nbr = ((amq_peer_agent_exchange_delete_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_exchange_delete_t *) data)-> ticket;
    exchange = ((amq_peer_agent_exchange_delete_t *) data)-> exchange;
    if_unused = ((amq_peer_agent_exchange_delete_t *) data)-> if_unused;
    nowait = ((amq_peer_agent_exchange_delete_t *) data)-> nowait;
    ...
    icl_longstr_t *  arguments)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_queue_declare_destructor);
...
icl_longstr_t * arguments;
    ...
    channel_nbr = ((amq_peer_agent_queue_declare_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_queue_declare_t *) data)-> ticket;
    queue = ((amq_peer_agent_queue_declare_t *) data)-> queue;
    passive = ((amq_peer_agent_queue_declare_t *) data)-> passive;
    durable = ((amq_peer_agent_queue_declare_t *) data)-> durable;
    exclusive = ((amq_peer_agent_queue_declare_t *) data)-> exclusive;
    auto_delete = ((amq_peer_agent_queue_declare_t *) data)-> auto_delete;
    nowait = ((amq_peer_agent_queue_declare_t *) data)-> nowait;
    arguments = ((amq_peer_agent_queue_declare_t *) data)-> arguments;
    ...
    icl_longstr_t *  arguments)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_queue_bind_destructor);
...
icl_longstr_t * arguments;
    ...
    channel_nbr = ((amq_peer_agent_queue_bind_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_queue_bind_t *) data)-> ticket;
    queue = ((amq_peer_agent_queue_bind_t *) data)-> queue;
    exchange = ((amq_peer_agent_queue_bind_t *) data)-> exchange;
    routing_key = ((amq_peer_agent_queue_bind_t *) data)-> routing_key;
    nowait = ((amq_peer_agent_queue_bind_t *) data)-> nowait;
    arguments = ((amq_peer_agent_queue_bind_t *) data)-> arguments;
    ...
    Bool           nowait)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_queue_purge_destructor);
...
Bool nowait;
    ...
    channel_nbr = ((amq_peer_agent_queue_purge_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_queue_purge_t *) data)-> ticket;
    queue = ((amq_peer_agent_queue_purge_t *) data)-> queue;
    nowait = ((amq_peer_agent_queue_purge_t *) data)-> nowait;
    ...
    Bool           nowait)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_queue_delete_destructor);
...
Bool nowait;
    ...
    channel_nbr = ((amq_peer_agent_queue_delete_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_queue_delete_t *) data)-> ticket;
    queue = ((amq_peer_agent_queue_delete_t *) data)-> queue;
    if_unused = ((amq_peer_agent_queue_delete_t *) data)-> if_unused;
    if_empty = ((amq_peer_agent_queue_delete_t *) data)-> if_empty;
    nowait = ((amq_peer_agent_queue_delete_t *) data)-> nowait;
    ...
    icl_longstr_t *  arguments)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_queue_unbind_destructor);
...
icl_longstr_t * arguments;
    ...
    channel_nbr = ((amq_peer_agent_queue_unbind_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_queue_unbind_t *) data)-> ticket;
    queue = ((amq_peer_agent_queue_unbind_t *) data)-> queue;
    exchange = ((amq_peer_agent_queue_unbind_t *) data)-> exchange;
    routing_key = ((amq_peer_agent_queue_unbind_t *) data)-> routing_key;
    nowait = ((amq_peer_agent_queue_unbind_t *) data)-> nowait;
    arguments = ((amq_peer_agent_queue_unbind_t *) data)-> arguments;
    ...
    Bool           global)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_qos_destructor);
...
Bool global;
    ...
    channel_nbr = ((amq_peer_agent_basic_qos_t *) data)-> channel_nbr;
    prefetch_size = ((amq_peer_agent_basic_qos_t *) data)-> prefetch_size;
    prefetch_count = ((amq_peer_agent_basic_qos_t *) data)-> prefetch_count;
    global = ((amq_peer_agent_basic_qos_t *) data)-> global;
    ...
    icl_longstr_t *  arguments)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_consume_destructor);
...
icl_longstr_t * arguments;
    ...
    channel_nbr = ((amq_peer_agent_basic_consume_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_basic_consume_t *) data)-> ticket;
    queue = ((amq_peer_agent_basic_consume_t *) data)-> queue;
    consumer_tag = ((amq_peer_agent_basic_consume_t *) data)-> consumer_tag;
    no_local = ((amq_peer_agent_basic_consume_t *) data)-> no_local;
    no_ack = ((amq_peer_agent_basic_consume_t *) data)-> no_ack;
    exclusive = ((amq_peer_agent_basic_consume_t *) data)-> exclusive;
    nowait = ((amq_peer_agent_basic_consume_t *) data)-> nowait;
    arguments = ((amq_peer_agent_basic_consume_t *) data)-> arguments;
    ...
    Bool           nowait)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_cancel_destructor);
...
Bool nowait;
    ...
    channel_nbr = ((amq_peer_agent_basic_cancel_t *) data)-> channel_nbr;
    consumer_tag = ((amq_peer_agent_basic_cancel_t *) data)-> consumer_tag;
    nowait = ((amq_peer_agent_basic_cancel_t *) data)-> nowait;
    ...
    Bool           immediate)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_publish_destructor);
...
Bool immediate;
    ...
    channel_nbr = ((amq_peer_agent_basic_publish_t *) data)-> channel_nbr;
    content = ((amq_peer_agent_basic_publish_t *) data)-> content;
    ticket = ((amq_peer_agent_basic_publish_t *) data)-> ticket;
    exchange = ((amq_peer_agent_basic_publish_t *) data)-> exchange;
    routing_key = ((amq_peer_agent_basic_publish_t *) data)-> routing_key;
    mandatory = ((amq_peer_agent_basic_publish_t *) data)-> mandatory;
    immediate = ((amq_peer_agent_basic_publish_t *) data)-> immediate;
    ...
    Bool           no_ack)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_get_destructor);
...
Bool no_ack;
    ...
    channel_nbr = ((amq_peer_agent_basic_get_t *) data)-> channel_nbr;
    ticket = ((amq_peer_agent_basic_get_t *) data)-> ticket;
    queue = ((amq_peer_agent_basic_get_t *) data)-> queue;
    no_ack = ((amq_peer_agent_basic_get_t *) data)-> no_ack;
    ...
    Bool           multiple)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_ack_destructor);
...
Bool multiple;
    ...
    channel_nbr = ((amq_peer_agent_basic_ack_t *) data)-> channel_nbr;
    delivery_tag = ((amq_peer_agent_basic_ack_t *) data)-> delivery_tag;
    multiple = ((amq_peer_agent_basic_ack_t *) data)-> multiple;
    ...
    Bool           requeue)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_basic_reject_destructor);
...
Bool requeue;
    ...
    channel_nbr = ((amq_peer_agent_basic_reject_t *) data)-> channel_nbr;
    delivery_tag = ((amq_peer_agent_basic_reject_t *) data)-> delivery_tag;
    requeue = ((amq_peer_agent_basic_reject_t *) data)-> requeue;
    ...
    char *         sink)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_direct_put_destructor);
...
char * sink;
    ...
    channel_nbr = ((amq_peer_agent_direct_put_t *) data)-> channel_nbr;
    sink = ((amq_peer_agent_direct_put_t *) data)-> sink;
    ...
    char *         feed)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_direct_get_destructor);
...
char * feed;
    ...
    channel_nbr = ((amq_peer_agent_direct_get_t *) data)-> channel_nbr;
    feed = ((amq_peer_agent_direct_get_t *) data)-> feed;
    ...
    char *         pipe_name)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_pipe_create_destructor);
...
char * pipe_name;
    ...
    channel_nbr = ((amq_peer_agent_restms_pipe_create_t *) data)-> channel_nbr;
    pipe_type = ((amq_peer_agent_restms_pipe_create_t *) data)-> pipe_type;
    pipe_name = ((amq_peer_agent_restms_pipe_create_t *) data)-> pipe_name;
    ...
    char *         pipe_name)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_pipe_delete_destructor);
...
char * pipe_name;
    ...
    channel_nbr = ((amq_peer_agent_restms_pipe_delete_t *) data)-> channel_nbr;
    pipe_name = ((amq_peer_agent_restms_pipe_delete_t *) data)-> pipe_name;
    ...
    char *         feed_name)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_feed_create_destructor);
...
char * feed_name;
    ...
    channel_nbr = ((amq_peer_agent_restms_feed_create_t *) data)-> channel_nbr;
    feed_type = ((amq_peer_agent_restms_feed_create_t *) data)-> feed_type;
    feed_name = ((amq_peer_agent_restms_feed_create_t *) data)-> feed_name;
    ...
    char *         feed_name)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_feed_delete_destructor);
...
char * feed_name;
    ...
    channel_nbr = ((amq_peer_agent_restms_feed_delete_t *) data)-> channel_nbr;
    feed_name = ((amq_peer_agent_restms_feed_delete_t *) data)-> feed_name;
    ...
    char *         address)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_join_create_destructor);
...
char * address;
    ...
    channel_nbr = ((amq_peer_agent_restms_join_create_t *) data)-> channel_nbr;
    pipe_name = ((amq_peer_agent_restms_join_create_t *) data)-> pipe_name;
    feed_name = ((amq_peer_agent_restms_join_create_t *) data)-> feed_name;
    address = ((amq_peer_agent_restms_join_create_t *) data)-> address;
    ...
    char *         address)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_restms_join_delete_destructor);
...
char * address;
    ...
    channel_nbr = ((amq_peer_agent_restms_join_delete_t *) data)-> channel_nbr;
    pipe_name = ((amq_peer_agent_restms_join_delete_t *) data)-> pipe_name;
    feed_name = ((amq_peer_agent_restms_join_delete_t *) data)-> feed_name;
    address = ((amq_peer_agent_restms_join_delete_t *) data)-> address;
    ...
    amq_peer_method_t *  method)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_peer_agent_push_destructor);
...
amq_peer_method_t * method;
    ...
    channel_nbr = ((amq_peer_agent_push_t *) data)-> channel_nbr;
    method = ((amq_peer_agent_push_t *) data)-> method;
    ...
    smt_thread_t * thread)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = smt_method_send (
                thread->reply_queue,
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_channel_open_send (
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_channel_close_send (
    ...
    Bool                  active)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_channel_flow_send (
    ...
    Bool                  active)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_channel_flow_ok_send (
    ...
    icl_longstr_t *       arguments)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_exchange_declare_send (
    ...
    Bool                  nowait)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_exchange_delete_send (
    ...
    icl_longstr_t *       arguments)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_queue_declare_send (
    ...
    icl_longstr_t *       arguments)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_queue_bind_send (
    ...
    Bool                  nowait)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_queue_purge_send (
    ...
    Bool                  nowait)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_queue_delete_send (
    ...
    icl_longstr_t *       arguments)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_queue_unbind_send (
    ...
    Bool                  global)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_qos_send (
    ...
    icl_longstr_t *       arguments)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_consume_send (
    ...
    Bool                  nowait)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_cancel_send (
    ...
    Bool                  immediate)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_publish_send (
    ...
    Bool                  no_ack)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_get_send (
    ...
    Bool                  multiple)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_ack_send (
    ...
    Bool                  requeue)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_basic_reject_send (
    ...
    char *                sink)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_direct_put_send (
    ...
    char *                feed)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_direct_get_send (
...
int
amq_peer_agent_restms_pipe_create (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                pipe_type,
    char *                pipe_name)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_pipe_create_send (
...
int
amq_peer_agent_restms_pipe_delete (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                pipe_name)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_pipe_delete_send (
...
int
amq_peer_agent_restms_feed_create (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                feed_type,
    char *                feed_name)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_feed_create_send (
...
int
amq_peer_agent_restms_feed_delete (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                feed_name)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_feed_delete_send (
...
int
amq_peer_agent_restms_join_create (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                pipe_name,
    char *                feed_name,
    char *                address)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_join_create_send (
...
int
amq_peer_agent_restms_join_delete (
    smt_thread_t * thread,
    dbyte                 channel_nbr,
    char *                pipe_name,
    char *                feed_name,
    char *                address)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_peer_agent_manager);
        rc = amq_peer_agent_restms_join_delete_send (
...
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
    ...
    dbyte faulting_method_id)           //  Faulting method id, if any
{
    ...
    //  Save reply code for amq_peer_connection
    ...
    )
{
    ...
    &&  tcb->method_in->method_id == method_id) {
        amq_peer_method_execute (tcb->method_in, tcb->caller, thread);
    }
    else
    ...
    smt_log_t *log)
{
    ...
    if (tcb->trace >= ASL_TRACE_LOW)
        amq_peer_method_dump (tcb->method_out, log, "I: send ");

    //  Send the method
    payload = amq_peer_method_encode (tcb->method_out);
...
void
amq_peer_agent_term (void)
{

}

int 
amq_peer_agent_init (void)
{
    int
        rc = SMT_OK;                    //  Return code

    s_connection_context_cache = icl_cache_get (sizeof (amq_peer_agent_connection_context_t));
    s_channel_open_cache = icl_cache_get (sizeof (amq_peer_agent_channel_open_t));
    s_channel_close_cache = icl_cache_get (sizeof (amq_peer_agent_channel_close_t));
    s_channel_flow_cache = icl_cache_get (sizeof (amq_peer_agent_channel_flow_t));
    s_channel_flow_ok_cache = icl_cache_get (sizeof (amq_peer_agent_channel_flow_ok_t));
    s_exchange_declare_cache = icl_cache_get (sizeof (amq_peer_agent_exchange_declare_t));
    s_exchange_delete_cache = icl_cache_get (sizeof (amq_peer_agent_exchange_delete_t));
    s_queue_declare_cache = icl_cache_get (sizeof (amq_peer_agent_queue_declare_t));
    s_queue_bind_cache = icl_cache_get (sizeof (amq_peer_agent_queue_bind_t));
    s_queue_purge_cache = icl_cache_get (sizeof (amq_peer_agent_queue_purge_t));
    s_queue_delete_cache = icl_cache_get (sizeof (amq_peer_agent_queue_delete_t));
    s_queue_unbind_cache = icl_cache_get (sizeof (amq_peer_agent_queue_unbind_t));
    s_basic_qos_cache = icl_cache_get (sizeof (amq_peer_agent_basic_qos_t));
    s_basic_consume_cache = icl_cache_get (sizeof (amq_peer_agent_basic_consume_t));
    s_basic_cancel_cache = icl_cache_get (sizeof (amq_peer_agent_basic_cancel_t));
    s_basic_publish_cache = icl_cache_get (sizeof (amq_peer_agent_basic_publish_t));
    s_basic_get_cache = icl_cache_get (sizeof (amq_peer_agent_basic_get_t));
    s_basic_ack_cache = icl_cache_get (sizeof (amq_peer_agent_basic_ack_t));
    s_basic_reject_cache = icl_cache_get (sizeof (amq_peer_agent_basic_reject_t));
    s_direct_put_cache = icl_cache_get (sizeof (amq_peer_agent_direct_put_t));
    s_direct_get_cache = icl_cache_get (sizeof (amq_peer_agent_direct_get_t));
    s_restms_pipe_create_cache = icl_cache_get (sizeof (amq_peer_agent_restms_pipe_create_t));
    s_restms_pipe_delete_cache = icl_cache_get (sizeof (amq_peer_agent_restms_pipe_delete_t));
    s_restms_feed_create_cache = icl_cache_get (sizeof (amq_peer_agent_restms_feed_create_t));
    s_restms_feed_delete_cache = icl_cache_get (sizeof (amq_peer_agent_restms_feed_delete_t));
    s_restms_join_create_cache = icl_cache_get (sizeof (amq_peer_agent_restms_join_create_t));
    s_restms_join_delete_cache = icl_cache_get (sizeof (amq_peer_agent_restms_join_delete_t));
    s_push_cache = icl_cache_get (sizeof (amq_peer_agent_push_t));
    ...
    icl_system_register (NULL, amq_peer_agent_term);
    
    return rc;
}

void
amq_peer_agent_animate (Bool animate)
{
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_PEER_AGENT))
    s_animate = animate;
#endif
...
smt_thread_t *
amq_peer_agent_connection_thread_new (
    ...
    Bool verbose)
{
    ...
    thread = smt_thread_new (amq_peer_agent_manager,
                             amq_peer_agent_catcher,
                             amq_peer_agent_connection_destroy);
                             
    thread->schedule = SMT_SCHEDULE_POLL;

#if (defined (AMQ_PEER_AGENT_TRACE))
    ...
    if (thread) {
        ...
        memset (thread->context, 0, sizeof (amq_peer_agent_connection_context_t));
        ((amq_peer_agent_connection_context_t *) thread->context)->links = 1;
        thread->event_name = event_name;
{
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)

        tcb->caller  = amq_peering_link (caller);
        tcb->verbose = verbose;
...
smt_thread_t *
amq_peer_agent_input_thread_new (
    smt_thread_t * share)
{
    smt_thread_t
        *thread;
...
smt_thread_t *
amq_peer_agent_heartbeat_thread_new (
    smt_thread_t * share)
{
    smt_thread_t
        *thread;
    ...
    thread = smt_thread_new (amq_peer_agent_manager,
                             amq_peer_agent_catcher,
                             amq_peer_agent_heartbeat_destroy);
...
static int
amq_peer_agent_manager (smt_thread_t **thread_p)
{
    smt_thread_t
        *thread = *thread_p;
...
#undef  tcb
            ...
            switch (thread->_next_event) {
                ...
                case connect_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_PEER_AGENT))
...
static int
amq_peer_agent_catcher (smt_thread_t *thread)
{
...
static int    
amq_peer_agent_connection_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_PEER_AGENT))
...
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
        ...
        //  Free resources
        amq_peer_method_unlink (&tcb->method_in);
        amq_peer_method_unlink (&tcb->method_out);
        ipr_bucket_unlink       (&tcb->bucket_in);
        icl_longstr_destroy     (&tcb->auth_data);
        smt_socket_destroy      (&tcb->socket);
        amq_peering_unlink (&tcb->caller);
    
#undef  tcb
}
    if (--((amq_peer_agent_connection_context_t *) thread->context)->links == 0)
...
static int    
amq_peer_agent_input_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_PEER_AGENT))
    //  Don't trust thread->os_thread while destroying thread.
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 0);
...
static int    
amq_peer_agent_heartbeat_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_PEER_AGENT))
    //  Don't trust thread->os_thread while destroying thread.
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 0);
...
report_unrecognised_event_error (smt_thread_t *thread)
{
    ...
    icl_console_print ("amq_peer_agent: Unrecognised event '%s' in '%s' thread number: %u, state: %s",
                       event_name_or_number,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SET_NO_CONNECTION_ERROR))
    icl_stats_inc ("amq_peer_agent_set_no_connection_error", &s_amq_peer_agent_set_no_connection_error_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_SETUP_TIMER))
    icl_stats_inc ("amq_peer_agent_start_setup_timer", &s_amq_peer_agent_start_setup_timer_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CONNECT_TO_SERVER))
    icl_stats_inc ("amq_peer_agent_connect_to_server", &s_amq_peer_agent_connect_to_server_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->socket) {
            ...
            rc = smt_socket_set_nodelay (tcb->socket,
                amq_peer_config_tcp_nodelay (amq_peer_config));
            if (rc && tcb->verbose)
                smt_log_print (amq_broker->alert_log,
                    "W: could not set TCP_NODELAY on socket");

            //  Set socket buffers if wanted
            new_size = amq_peer_config_tcp_rcvbuf (amq_peer_config);
            if (new_size)
            ...
            new_size = amq_peer_config_tcp_sndbuf (amq_peer_config);
            if (new_size)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_PROTOCOL_HEADER))
    icl_stats_inc ("amq_peer_agent_send_protocol_header", &s_amq_peer_agent_send_protocol_header_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_FRAME_HEADER))
    icl_stats_inc ("amq_peer_agent_read_frame_header", &s_amq_peer_agent_read_frame_header_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_PROTOCOL_HEADER))
    icl_stats_inc ("amq_peer_agent_check_protocol_header", &s_amq_peer_agent_check_protocol_header_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_PROTOCOL_VERSION))
    icl_stats_inc ("amq_peer_agent_read_protocol_version", &s_amq_peer_agent_read_protocol_version_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_VERSION_MISMATCH))
    icl_stats_inc ("amq_peer_agent_report_version_mismatch", &s_amq_peer_agent_report_version_mismatch_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_BAD_PROTOCOL))
    icl_stats_inc ("amq_peer_agent_report_bad_protocol", &s_amq_peer_agent_report_bad_protocol_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_START))
    icl_stats_inc ("amq_peer_agent_execute_connection_start", &s_amq_peer_agent_execute_connection_start_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        s_execute_method (thread, FALSE,
            AMQ_PEER_CONNECTION, AMQ_PEER_CONNECTION_START);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_INPUT_THREAD))
    icl_stats_inc ("amq_peer_agent_start_input_thread", &s_amq_peer_agent_start_input_thread_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        //  Start input thread
        input_thread = amq_peer_agent_input_thread_new (thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_START_OK))
    icl_stats_inc ("amq_peer_agent_send_connection_start_ok", &s_amq_peer_agent_send_connection_start_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        asl_field_new_string (field_list, "product", "OpenAMQ peering client");
        ...
        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_connection_start_ok (
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_TUNE_OK))
    icl_stats_inc ("amq_peer_agent_send_connection_tune_ok", &s_amq_peer_agent_send_connection_tune_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_connection_tune_ok (
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_HEARTBEAT_THREAD))
    icl_stats_inc ("amq_peer_agent_start_heartbeat_thread", &s_amq_peer_agent_start_heartbeat_thread_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->heartbeat) {
            heartbeat_thread = amq_peer_agent_heartbeat_thread_new (thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_START_HEARTBEAT_TIMER))
    icl_stats_inc ("amq_peer_agent_start_heartbeat_timer", &s_amq_peer_agent_start_heartbeat_timer_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CANCEL_SETUP_TIMER))
    icl_stats_inc ("amq_peer_agent_cancel_setup_timer", &s_amq_peer_agent_cancel_setup_timer_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_OPEN))
    icl_stats_inc ("amq_peer_agent_send_connection_open", &s_amq_peer_agent_send_connection_open_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_connection_open (
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_FLOW))
    icl_stats_inc ("amq_peer_agent_send_channel_flow", &s_amq_peer_agent_send_channel_flow_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_FLOW_OK))
    icl_stats_inc ("amq_peer_agent_send_channel_flow_ok", &s_amq_peer_agent_send_channel_flow_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_EXCHANGE_DECLARE))
    icl_stats_inc ("amq_peer_agent_send_exchange_declare", &s_amq_peer_agent_send_exchange_declare_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_EXCHANGE_DELETE))
    icl_stats_inc ("amq_peer_agent_send_exchange_delete", &s_amq_peer_agent_send_exchange_delete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_DECLARE))
    icl_stats_inc ("amq_peer_agent_send_queue_declare", &s_amq_peer_agent_send_queue_declare_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_BIND))
    icl_stats_inc ("amq_peer_agent_send_queue_bind", &s_amq_peer_agent_send_queue_bind_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_PURGE))
    icl_stats_inc ("amq_peer_agent_send_queue_purge", &s_amq_peer_agent_send_queue_purge_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_DELETE))
    icl_stats_inc ("amq_peer_agent_send_queue_delete", &s_amq_peer_agent_send_queue_delete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_QUEUE_UNBIND))
    icl_stats_inc ("amq_peer_agent_send_queue_unbind", &s_amq_peer_agent_send_queue_unbind_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_QOS))
    icl_stats_inc ("amq_peer_agent_send_basic_qos", &s_amq_peer_agent_send_basic_qos_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_CONSUME))
    icl_stats_inc ("amq_peer_agent_send_basic_consume", &s_amq_peer_agent_send_basic_consume_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_CANCEL))
    icl_stats_inc ("amq_peer_agent_send_basic_cancel", &s_amq_peer_agent_send_basic_cancel_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_PUBLISH))
    icl_stats_inc ("amq_peer_agent_send_basic_publish", &s_amq_peer_agent_send_basic_publish_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_GET))
    icl_stats_inc ("amq_peer_agent_send_basic_get", &s_amq_peer_agent_send_basic_get_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_ACK))
    icl_stats_inc ("amq_peer_agent_send_basic_ack", &s_amq_peer_agent_send_basic_ack_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_BASIC_REJECT))
    icl_stats_inc ("amq_peer_agent_send_basic_reject", &s_amq_peer_agent_send_basic_reject_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_DIRECT_PUT))
    icl_stats_inc ("amq_peer_agent_send_direct_put", &s_amq_peer_agent_send_direct_put_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_DIRECT_GET))
    icl_stats_inc ("amq_peer_agent_send_direct_get", &s_amq_peer_agent_send_direct_get_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_PIPE_CREATE))
    icl_stats_inc ("amq_peer_agent_send_restms_pipe_create", &s_amq_peer_agent_send_restms_pipe_create_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_PIPE_DELETE))
    icl_stats_inc ("amq_peer_agent_send_restms_pipe_delete", &s_amq_peer_agent_send_restms_pipe_delete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_FEED_CREATE))
    icl_stats_inc ("amq_peer_agent_send_restms_feed_create", &s_amq_peer_agent_send_restms_feed_create_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_FEED_DELETE))
    icl_stats_inc ("amq_peer_agent_send_restms_feed_delete", &s_amq_peer_agent_send_restms_feed_delete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_JOIN_CREATE))
    icl_stats_inc ("amq_peer_agent_send_restms_join_create", &s_amq_peer_agent_send_restms_join_create_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_RESTMS_JOIN_DELETE))
    icl_stats_inc ("amq_peer_agent_send_restms_join_delete", &s_amq_peer_agent_send_restms_join_delete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_OPEN))
    icl_stats_inc ("amq_peer_agent_send_channel_open", &s_amq_peer_agent_send_channel_open_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_CLOSED) {
            ...
            amq_peer_method_unlink (&tcb->method_out);
            tcb->method_out = amq_peer_method_new_channel_open (NULL);
            s_send_method_out (thread, 1, NULL);
        }
        else
            ...
            s_connection_exception (thread,
                ...
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_OPEN);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_CLOSE))
    icl_stats_inc ("amq_peer_agent_send_channel_close", &s_amq_peer_agent_send_channel_close_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            //  Send the method
            amq_peer_method_unlink (&tcb->method_out);
            tcb->method_out = amq_peer_method_new_channel_close (
            ...
            s_connection_exception (thread,
                ...
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_CLOSE);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CHANNEL_CLOSE_OK))
    icl_stats_inc ("amq_peer_agent_send_channel_close_ok", &s_amq_peer_agent_send_channel_close_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_channel_close_ok ();
        s_send_method_out (thread, 1, NULL);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_PUSH_METHOD_TO_SERVER))
    icl_stats_inc ("amq_peer_agent_push_method_to_server", &s_amq_peer_agent_push_method_to_server_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            amq_peer_method_unlink (&tcb->method_out);
            tcb->method_out = amq_peer_method_link (push_m->method);
            s_send_method_out (thread, 1, NULL);
        }
        else
            //  Channel is not OPEN, discard method
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONTENT_HEADER))
    icl_stats_inc ("amq_peer_agent_send_content_header", &s_amq_peer_agent_send_content_header_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_out->content) {
            ...
            if (tcb->method_out->class_id == AMQ_PEER_BASIC) {
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONTENT_BODY_FRAME))
    icl_stats_inc ("amq_peer_agent_send_content_body_frame", &s_amq_peer_agent_send_content_body_frame_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SHUT_DOWN_SLAVE_THREADS))
    icl_stats_inc ("amq_peer_agent_shut_down_slave_threads", &s_amq_peer_agent_shut_down_slave_threads_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SMT_ERROR))
    icl_stats_inc ("amq_peer_agent_report_smt_error", &s_amq_peer_agent_report_smt_error_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_CLOSE))
    icl_stats_inc ("amq_peer_agent_send_connection_close", &s_amq_peer_agent_send_connection_close_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_connection_close (
            tcb->reply_code, tcb->reply_text, 0, 0);
        s_send_method_out (thread, 0, NULL);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_CLOSE))
    icl_stats_inc ("amq_peer_agent_execute_connection_close", &s_amq_peer_agent_execute_connection_close_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_CONNECTION_CLOSE_OK))
    icl_stats_inc ("amq_peer_agent_send_connection_close_ok", &s_amq_peer_agent_send_connection_close_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_method_unlink (&tcb->method_out);
        tcb->method_out = amq_peer_method_new_connection_close_ok ();
        s_send_method_out (thread, 0, NULL);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_FLUSH_THE_CONNECTION))
    icl_stats_inc ("amq_peer_agent_flush_the_connection", &s_amq_peer_agent_flush_the_connection_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SOCKET_ERROR))
    icl_stats_inc ("amq_peer_agent_report_socket_error", &s_amq_peer_agent_report_socket_error_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_CONNECT_ERROR))
    icl_stats_inc ("amq_peer_agent_report_connect_error", &s_amq_peer_agent_report_connect_error_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_SOCKET_TIMEOUT))
    icl_stats_inc ("amq_peer_agent_report_socket_timeout", &s_amq_peer_agent_report_socket_timeout_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_CONNECT_TIMEOUT))
    icl_stats_inc ("amq_peer_agent_report_connect_timeout", &s_amq_peer_agent_report_connect_timeout_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SEND_HEARTBEAT_FRAME))
    icl_stats_inc ("amq_peer_agent_send_heartbeat_frame", &s_amq_peer_agent_send_heartbeat_frame_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_READ_FRAME_PAYLOAD))
    icl_stats_inc ("amq_peer_agent_read_frame_payload", &s_amq_peer_agent_read_frame_payload_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_FRAME_FORMAT))
    icl_stats_inc ("amq_peer_agent_check_frame_format", &s_amq_peer_agent_check_frame_format_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DECODE_METHOD))
    icl_stats_inc ("amq_peer_agent_decode_method", &s_amq_peer_agent_decode_method_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->frame_header.type == ASL_FRAME_METHOD) {
            amq_peer_method_unlink (&tcb->method_in);
            tcb->method_in = amq_peer_method_decode (tcb->bucket_in,
                tcb->strerror);
            if (tcb->method_in) {
                if (tcb->trace >= ASL_TRACE_LOW)
                    amq_peer_method_dump (tcb->method_in, NULL, "I: recv ");
            }
            else
                s_connection_abort (thread,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_METHOD_CLASS))
    icl_stats_inc ("amq_peer_agent_check_method_class", &s_amq_peer_agent_check_method_class_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        if (tcb->method_in->class_id == AMQ_PEER_CONNECTION)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id == AMQ_PEER_CHANNEL)
            smt_thread_set_next_event (thread, channel_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_PEER_BASIC
        &&  tcb->method_in->method_id == AMQ_PEER_BASIC_RETURN)
            smt_thread_set_next_event (thread, basic_content_event);
        else
        if (tcb->method_in->class_id  == AMQ_PEER_BASIC
        &&  tcb->method_in->method_id == AMQ_PEER_BASIC_DELIVER)
            smt_thread_set_next_event (thread, basic_content_event);
        else
        if (tcb->method_in->class_id  == AMQ_PEER_BASIC
        &&  tcb->method_in->method_id == AMQ_PEER_BASIC_GET_OK)
            smt_thread_set_next_event (thread, basic_content_event);
        else
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_CONNECTION_METHOD))
    icl_stats_inc ("amq_peer_agent_check_connection_method", &s_amq_peer_agent_check_connection_method_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_in->method_id == AMQ_PEER_CONNECTION_TUNE)
            smt_thread_set_next_event (thread, connection_tune_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CONNECTION_OPEN_OK)
            smt_thread_set_next_event (thread, connection_open_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CONNECTION_CLOSE)
            smt_thread_set_next_event (thread, connection_close_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CONNECTION_CLOSE_OK)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_CHANNEL_METHOD))
    icl_stats_inc ("amq_peer_agent_check_channel_method", &s_amq_peer_agent_check_channel_method_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_in->method_id == AMQ_PEER_CHANNEL_OPEN_OK)
            smt_thread_set_next_event (thread, channel_open_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CHANNEL_CLOSE)
            smt_thread_set_next_event (thread, channel_close_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CHANNEL_CLOSE_OK)
            smt_thread_set_next_event (thread, channel_close_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CHANNEL_FLOW)
            smt_thread_set_next_event (thread, channel_flow_event);
        else
        if (tcb->method_in->method_id == AMQ_PEER_CHANNEL_FLOW_OK)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_FUNCTIONAL_METHOD))
    icl_stats_inc ("amq_peer_agent_execute_functional_method", &s_amq_peer_agent_execute_functional_method_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_TUNE))
    icl_stats_inc ("amq_peer_agent_execute_connection_tune", &s_amq_peer_agent_execute_connection_tune_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        s_execute_method (thread, FALSE,
            AMQ_PEER_CONNECTION, AMQ_PEER_CONNECTION_TUNE);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_TUNE))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_tune", &s_amq_peer_agent_notify_connection_of_tune_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_agent_connection_tune (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CONNECTION_OPEN_OK))
    icl_stats_inc ("amq_peer_agent_execute_connection_open_ok", &s_amq_peer_agent_execute_connection_open_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        s_execute_method (thread, FALSE,
            AMQ_PEER_CONNECTION, AMQ_PEER_CONNECTION_OPEN_OK);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_OPEN_OK))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_open_ok", &s_amq_peer_agent_notify_connection_of_open_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_agent_connection_open_ok (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_PASSIVE_CLOSE))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_passive_close", &s_amq_peer_agent_notify_connection_of_passive_close_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_CLOSE_OK))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_close_ok", &s_amq_peer_agent_notify_connection_of_close_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        amq_peer_agent_connection_close_ok (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_OPEN_OK))
    icl_stats_inc ("amq_peer_agent_execute_channel_open_ok", &s_amq_peer_agent_execute_channel_open_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPENING) {
            ...
            s_connection_exception (thread,
                ...
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_OPEN_OK);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_CLOSE))
    icl_stats_inc ("amq_peer_agent_execute_channel_close", &s_amq_peer_agent_execute_channel_close_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            //  Channel is now CLOSING
            tcb->channel_state = ASL_CHANNEL_CLOSING;
            //  Save reply code for amq_peer_session
            ...
            amq_peer_agent_send_channel_close_ok (tcb->connection_thread);
        }
        else
            //  Channel is not OPEN
            s_connection_exception (thread,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_CLOSE_OK))
    icl_stats_inc ("amq_peer_agent_execute_channel_close_ok", &s_amq_peer_agent_execute_channel_close_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_CLOSING) {
            ...
            s_connection_exception (thread,
                ...
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_CLOSE_OK);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_FLOW))
    icl_stats_inc ("amq_peer_agent_execute_channel_flow", &s_amq_peer_agent_execute_channel_flow_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            s_execute_method (thread, TRUE,
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_FLOW);
        }
        else
            s_connection_exception (thread,
                ASL_CHANNEL_ERROR, "Channel is not open",
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXECUTE_CHANNEL_FLOW_OK))
    icl_stats_inc ("amq_peer_agent_execute_channel_flow_ok", &s_amq_peer_agent_execute_channel_flow_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            s_execute_method (thread, TRUE,
                AMQ_PEER_CHANNEL, AMQ_PEER_CHANNEL_FLOW_OK);
        }
        else
            s_connection_exception (thread,
                ASL_CHANNEL_ERROR, "Channel is not open",
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONTENT_BASIC_HEADER))
    icl_stats_inc ("amq_peer_agent_expect_content_basic_header", &s_amq_peer_agent_expect_content_basic_header_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->frame_header.type == ASL_FRAME_HEADER) {
            ...
            if (((amq_content_basic_t *)
                tcb->method_in->content)->class_id != AMQ_PEER_BASIC)
                s_connection_exception (thread, ASL_SYNTAX_ERROR,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_IF_BASIC_BODY_COMPLETE))
    icl_stats_inc ("amq_peer_agent_check_if_basic_body_complete", &s_amq_peer_agent_check_if_basic_body_complete_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONTENT_BASIC_BODY))
    icl_stats_inc ("amq_peer_agent_expect_content_basic_body", &s_amq_peer_agent_expect_content_basic_body_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_EXCEPTION_METHOD))
    icl_stats_inc ("amq_peer_agent_expect_exception_method", &s_amq_peer_agent_expect_exception_method_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{

        if (tcb->method_in->class_id  == AMQ_PEER_CONNECTION &&
            tcb->method_in->method_id == AMQ_PEER_CONNECTION_CLOSE)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_PEER_CONNECTION &&
            tcb->method_in->method_id == AMQ_PEER_CONNECTION_CLOSE_OK)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_PEER_CHANNEL &&
            tcb->method_in->method_id == AMQ_PEER_CHANNEL_CLOSE)
            smt_thread_set_next_event (thread, channel_class_event);
        else
            s_connection_exception (thread, ASL_SYNTAX_ERROR,
                "Method not allowed",
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_EXCEPTION))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_exception", &s_amq_peer_agent_notify_connection_of_exception_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_NOTIFY_CONNECTION_OF_ERROR))
    icl_stats_inc ("amq_peer_agent_notify_connection_of_error", &s_amq_peer_agent_notify_connection_of_error_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_METHOD_FRAME))
    icl_stats_inc ("amq_peer_agent_expect_method_frame", &s_amq_peer_agent_expect_method_frame_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_EXPECT_CONNECTION_CLOSE_OK))
    icl_stats_inc ("amq_peer_agent_expect_connection_close_ok", &s_amq_peer_agent_expect_connection_close_ok_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_WAIT_FOR_HEARTBEAT_INTERVAL))
    icl_stats_inc ("amq_peer_agent_wait_for_heartbeat_interval", &s_amq_peer_agent_wait_for_heartbeat_interval_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_CHECK_PEER_LIVENESS))
    icl_stats_inc ("amq_peer_agent_check_peer_liveness", &s_amq_peer_agent_check_peer_liveness_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_PEER_SLOWING))
    icl_stats_inc ("amq_peer_agent_report_peer_slowing", &s_amq_peer_agent_report_peer_slowing_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_SHUT_DOWN_AGENT))
    icl_stats_inc ("amq_peer_agent_shut_down_agent", &s_amq_peer_agent_shut_down_agent_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_REPORT_PEER_STOPPED))
    icl_stats_inc ("amq_peer_agent_report_peer_stopped", &s_amq_peer_agent_report_peer_stopped_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_SEND_CONTENT_BODY_IF_ANY_START))
    icl_stats_inc ("amq_peer_agent_dialog_call_send_content_body_if_any_start", &s_amq_peer_agent_dialog_call_send_content_body_if_any_start_stats);
#endif        
    thread->module++;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_RETURN))
    icl_stats_inc ("amq_peer_agent_dialog_return", &s_amq_peer_agent_dialog_return_stats);
#endif        
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_PASSIVE_CLOSE))
    icl_stats_inc ("amq_peer_agent_dialog_call_close_the_connection_passive_close", &s_amq_peer_agent_dialog_call_close_the_connection_passive_close_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_48))
    icl_stats_inc ("amq_peer_agent_unnamed_48", &s_amq_peer_agent_unnamed_48_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_49))
    icl_stats_inc ("amq_peer_agent_unnamed_49", &s_amq_peer_agent_unnamed_49_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_UNNAMED_50))
    icl_stats_inc ("amq_peer_agent_unnamed_50", &s_amq_peer_agent_unnamed_50_stats);
#endif        
#define tcb ((amq_peer_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_ACTIVE_CLOSE))
    icl_stats_inc ("amq_peer_agent_dialog_call_close_the_connection_active_close", &s_amq_peer_agent_dialog_call_close_the_connection_active_close_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_READ_METHOD_READ_METHOD))
    icl_stats_inc ("amq_peer_agent_dialog_call_read_method_read_method", &s_amq_peer_agent_dialog_call_read_method_read_method_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_CONNECTION_CLOSING_CLOSING))
    icl_stats_inc ("amq_peer_agent_dialog_call_connection_closing_closing", &s_amq_peer_agent_dialog_call_connection_closing_closing_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_PEER_AGENT)  ||  defined (BASE_STATS_AMQ_PEER_AGENT_DIALOG_CALL_READ_BASIC_CONTENT_HEADER))
    icl_stats_inc ("amq_peer_agent_dialog_call_read_basic_content_header", &s_amq_peer_agent_dialog_call_read_basic_content_header_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
