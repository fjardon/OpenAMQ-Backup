...
<data name = "cml">
    <class name = "config" parent = "broker" label = "Configuration">
        <field name = "name" label = "Configuration name">
          <get>icl_shortstr_cpy (field_value, amq_server_config_filename (amq_server_config));</get>
        </field>
        ...
        <field name = "syslog" type = "int" label = "Use syslog logging protocol">
          <get>icl_shortstr_fmt (field_value, "%ld", amq_server_config_syslog (amq_server_config));</get>
          <put>
        ...
        <field name = "coremark_cycles" type = "int" label = "Duration of CoreMark test">
          <get>icl_shortstr_fmt (field_value, "%ld", amq_server_config_coremark_cycles (amq_server_config));</get>
          <put>
