...
#define self_show_animation  amq_exchange_system_show_animation
...
/*  -------------------------------------------------------------------------
    amq_exchange_system_show_animation
...
char *EMBED__amq_exchange_system_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_exchange_system_component  = "amq_exchange_system ";
char *EMBED__amq_exchange_system_version  = "1.0 ";
char *EMBED__amq_exchange_system_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_exchange_system_filename  = "amq_exchange_system.icl ";
char *EMBED__amq_exchange_system_builddate  = "2010/10/06 ";
char *EMBED__amq_exchange_system_version_end  = "VeRsIoNeNd:ipc";
