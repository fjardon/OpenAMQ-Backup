...
#define self_show_animation  amq_exchange_fanout_show_animation
...
/*  -------------------------------------------------------------------------
    amq_exchange_fanout_show_animation
...
char *EMBED__amq_exchange_fanout_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_exchange_fanout_component  = "amq_exchange_fanout ";
char *EMBED__amq_exchange_fanout_version  = "1.0 ";
char *EMBED__amq_exchange_fanout_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_exchange_fanout_filename  = "amq_exchange_fanout.icl ";
char *EMBED__amq_exchange_fanout_builddate  = "2010/10/06 ";
char *EMBED__amq_exchange_fanout_version_end  = "VeRsIoNeNd:ipc";
