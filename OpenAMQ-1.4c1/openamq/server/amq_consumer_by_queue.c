...
#define self_show_animation  amq_consumer_by_queue_show_animation
...
if (self) {
    ...
    if (self->links == 0) {
        icl_system_panic ("amq_consumer_by_queue", "E: missing link on amq_consumer_by_queue object");
...
/*  -------------------------------------------------------------------------
    amq_consumer_by_queue_show_animation
...
char *EMBED__amq_consumer_by_queue_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_consumer_by_queue_component  = "amq_consumer_by_queue ";
char *EMBED__amq_consumer_by_queue_version  = "1.0 ";
char *EMBED__amq_consumer_by_queue_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_consumer_by_queue_filename  = "amq_consumer_by_queue.icl ";
char *EMBED__amq_consumer_by_queue_builddate  = "2010/10/06 ";
char *EMBED__amq_consumer_by_queue_version_end  = "VeRsIoNeNd:ipc";
