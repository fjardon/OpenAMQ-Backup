...
#define delete_queue_m ((amq_broker_agent_delete_queue_t *) thread->method->data)
...
#define delete_queue_m_event_name                  "Delete-Queue-M"
...
#define delete_queue_action_name                   "Delete-Queue"
...
amq_broker_agent_delete_queue_t;
...
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT_DELETE_QUEUE))
static icl_stats_t *s_amq_broker_agent_delete_queue_stats = NULL;
#endif
...
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT_UNNAMED_22))
static icl_stats_t *s_amq_broker_agent_unnamed_22_stats = NULL;
#endif
...
static int    action_delete_queue             (smt_thread_t *thread);
...
static int
amq_broker_agent_delete_queue_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    amq_queue_t *  queue);
int
amq_broker_agent_delete_queue_destructor (void *data);
static int
    ...
    amq_queue_t *  queue)
{
    ...
    _message = icl_mem_cache_alloc (s_delete_queue_cache);
    _message->queue                     = queue;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_broker_agent_delete_queue_destructor);
...
amq_queue_t * queue;
    ...
    queue = ((amq_broker_agent_delete_queue_t *) data)-> queue;
    ...
    amq_queue_t *         queue)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_broker_agent_manager);
        rc = amq_broker_agent_delete_queue_send (
                thread->reply_queue, delete_queue_m_event,
                queue);
    }
    else
        rc = -1;
...
amq_broker_agent_init (void)
{
    ...
    s_delete_queue_cache = icl_cache_get (sizeof (amq_broker_agent_delete_queue_t));
        ...
        *thread_type = 1;
        if (thread->place < 16)
        ...
        else
          {
            *state_id = 2;
            switch (thread->place) {
                case 17: *event_id = 1;   *nextstate_id = 2;   break;
                case 18: *event_id = 2;   *nextstate_id = 2;   break;
                ...
                case 23: *event_id = 8;   *nextstate_id = 2;   break;
                case 24: *event_id = 9;   *nextstate_id = 2;   break;
                case 25: *event_id = 10;   *nextstate_id = 2;   break;
                case 26: *event_id = 11;   *nextstate_id = 2;   break;
                case 27: *event_id = 12;   *nextstate_id = 2;   break;
                case 28: *event_id = 13;   *nextstate_id = 2;   break;
                case 29: *event_id = 5;   break;
            }
          }
      }
}
...
static int
action_delete_queue (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT_DELETE_QUEUE))
    icl_stats_inc ("amq_broker_agent_delete_queue", &s_amq_broker_agent_delete_queue_stats);
#endif        
#define tcb ((amq_broker_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT)  ||  defined (BASE_STATS_AMQ_BROKER_AGENT_UNNAMED_22))
    icl_stats_inc ("amq_broker_agent_unnamed_22", &s_amq_broker_agent_unnamed_22_stats);
#endif        
#define tcb ((amq_broker_agent_class_context_t *) thread->context)
{
