<?xml?>
<!---------------------------------------------------------------------------
    amq_queue_connection_agent.smt - amq_queue_connection component
...
<agent
    name = "amq_queue_connection_agent"
    script = "smt_gen.gsl"
    animate = "0"
    >
...
<thread name = "class">
    ...
    <handler name = "thread new">
        <argument name = "self" type = "amq_queue_connection_t *">The iCL object</argument>
