/*---------------------------------------------------------------------------
    amq_server_agent.c - functions for amq_server_agent.
...
#define set_trace_m ((amq_server_agent_set_trace_t *) thread->method->data)

#define connection_error_m ((amq_server_agent_connection_error_t *) thread->method->data)

#define channel_error_m ((amq_server_agent_channel_error_t *) thread->method->data)

#define channel_flow_m ((amq_server_agent_channel_flow_t *) thread->method->data)

#define channel_flow_ok_m ((amq_server_agent_channel_flow_ok_t *) thread->method->data)

#define exchange_declare_ok_m ((amq_server_agent_exchange_declare_ok_t *) thread->method->data)

#define exchange_delete_ok_m ((amq_server_agent_exchange_delete_ok_t *) thread->method->data)

#define queue_declare_ok_m ((amq_server_agent_queue_declare_ok_t *) thread->method->data)

#define queue_bind_ok_m ((amq_server_agent_queue_bind_ok_t *) thread->method->data)

#define queue_purge_ok_m ((amq_server_agent_queue_purge_ok_t *) thread->method->data)

#define queue_delete_ok_m ((amq_server_agent_queue_delete_ok_t *) thread->method->data)

#define queue_unbind_ok_m ((amq_server_agent_queue_unbind_ok_t *) thread->method->data)

#define basic_qos_ok_m ((amq_server_agent_basic_qos_ok_t *) thread->method->data)

#define basic_consume_ok_m ((amq_server_agent_basic_consume_ok_t *) thread->method->data)

#define basic_cancel_ok_m ((amq_server_agent_basic_cancel_ok_t *) thread->method->data)

#define basic_return_m ((amq_server_agent_basic_return_t *) thread->method->data)

#define basic_deliver_m ((amq_server_agent_basic_deliver_t *) thread->method->data)

#define basic_get_ok_m ((amq_server_agent_basic_get_ok_t *) thread->method->data)

#define basic_get_empty_m ((amq_server_agent_basic_get_empty_t *) thread->method->data)

#define direct_put_ok_m ((amq_server_agent_direct_put_ok_t *) thread->method->data)

#define direct_get_ok_m ((amq_server_agent_direct_get_ok_t *) thread->method->data)

#define push_m ((amq_server_agent_push_t *) thread->method->data)

#define direct_out_m ((amq_server_agent_direct_out_t *) thread->method->data)
...
enum {
    ...
    queue_unbind_ok_m_event                        = 40,
    basic_qos_ok_m_event                           = 41,
    basic_consume_ok_m_event                       = 42,
    basic_cancel_ok_m_event                        = 43,
    basic_return_m_event                           = 44,
    start_event                                    = 45,
    continue_event                                 = 46,
    finished_event                                 = 47,
    basic_deliver_m_event                          = 48,
    basic_get_ok_m_event                           = 49,
    basic_get_empty_m_event                        = 50,
    direct_put_ok_m_event                          = 51,
    direct_get_ok_m_event                          = 52,
    push_m_event                                   = 53,
    channel_error_m_event                          = 54,
    send_channel_open_ok_m_event                   = 55,
    send_channel_close_ok_m_event                  = 56,
    connection_error_m_event                       = 57,
    kill_connection_m_event                        = 58,
    read_method_event                              = 59,
    closing_event                                  = 60,
    method_event                                   = 61,
    discard_frame_event                            = 62,
    connection_close_ok_event                      = 63,
    async_connection_error_event                   = 64,
    connection_class_event                         = 65,
    connection_start_ok_event                      = 66,
    connection_tune_ok_event                       = 67,
    connection_open_event                          = 68,
    channel_class_event                            = 69,
    channel_open_event                             = 70,
    channel_close_event                            = 71,
    channel_close_ok_event                         = 72,
    channel_flow_event                             = 73,
    channel_flow_ok_event                          = 74,
    basic_content_event                            = 75,
    header_event                                   = 76,
    expect_body_event                              = 77,
    other_method_event                             = 78,
    peer_alive_event                               = 79,
    peer_slowing_event                             = 80,
    peer_stopped_event                             = 81,
};

#define laststate                                  15
#define lastevent                                  81
#define lastplace                                  222

#define amq_server_agent_agent_name                "Amq-Server-Agent"
...
#define queue_unbind_ok_m_event_name               "Queue-Unbind-Ok-M"
#define basic_qos_ok_m_event_name                  "Basic-Qos-Ok-M"
#define basic_consume_ok_m_event_name              "Basic-Consume-Ok-M"
#define basic_cancel_ok_m_event_name               "Basic-Cancel-Ok-M"
#define basic_return_m_event_name                  "Basic-Return-M"
...
#define send_queue_unbind_ok_action_name           "Send-Queue-Unbind-Ok"
#define send_basic_qos_ok_action_name              "Send-Basic-Qos-Ok"
...
#define send_basic_return_action_name              "Send-Basic-Return"
...
#define unnamed_60_action_name                     "Unnamed-60"
#define unnamed_70_action_name                     "Unnamed-70"
#define unnamed_71_action_name                     "Unnamed-71"
#define unnamed_72_action_name                     "Unnamed-72"
#define unnamed_73_action_name                     "Unnamed-73"
#define unnamed_74_action_name                     "Unnamed-74"
...
amq_server_agent_connection_error_t;
...
amq_server_agent_channel_error_t;
...
amq_server_agent_channel_flow_t;
...
amq_server_agent_channel_flow_ok_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_server_agent_exchange_declare_ok_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_server_agent_exchange_delete_ok_t;
...
amq_server_agent_queue_declare_ok_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_server_agent_queue_bind_ok_t;
...
amq_server_agent_queue_purge_ok_t;
...
amq_server_agent_queue_delete_ok_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_server_agent_queue_unbind_ok_t;

typedef struct
  {
    dbyte          channel_nbr;
  }
amq_server_agent_basic_qos_ok_t;
...
amq_server_agent_basic_consume_ok_t;
...
amq_server_agent_basic_cancel_ok_t;
...
amq_server_agent_basic_return_t;
...
amq_server_agent_basic_deliver_t;
...
amq_server_agent_basic_get_ok_t;
...
amq_server_agent_basic_get_empty_t;
...
amq_server_agent_direct_put_ok_t;
...
amq_server_agent_direct_get_ok_t;
...
} amq_server_agent_connection_context_t;
...
} amq_server_agent_master_context_t;
...
static icl_cache_t
    *s_queue_unbind_ok_cache = NULL;
static icl_cache_t
    *s_basic_qos_ok_cache = NULL;
static icl_cache_t
    *s_basic_consume_ok_cache = NULL;
static icl_cache_t
    *s_basic_cancel_ok_cache = NULL;
static icl_cache_t
    *s_basic_return_cache = NULL;
static icl_cache_t
...
static const char *event_name [] = {
    ...
    queue_unbind_ok_m_event_name,
    basic_qos_ok_m_event_name,
    basic_consume_ok_m_event_name,
    basic_cancel_ok_m_event_name,
    basic_return_m_event_name,
    start_event_name,
    continue_event_name,
    finished_event_name,
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_SERVER_AGENT)         ||  defined (BASE_TRACE)  || defined (BASE_TRACE_AMQ_SERVER_AGENT)   ||  defined (AMQ_SERVER_AGENT_TRACE))
static const char *action_name [] = {
    ...
    send_queue_unbind_ok_action_name,
    send_basic_qos_ok_action_name,
    send_basic_consume_ok_action_name,
    send_basic_cancel_ok_action_name,
    send_basic_return_action_name,
    ...
    unnamed_60_action_name,
    unnamed_70_action_name,
    unnamed_71_action_name,
    unnamed_72_action_name,
    unnamed_73_action_name,
    unnamed_74_action_name,
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_SERVER_AGENT))
static Bool
    s_animate = FALSE;
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_INITIALISE_SERVER))
static icl_stats_t *s_amq_server_agent_initialise_server_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ALLOW_THREAD_TO_SETTLE))
static icl_stats_t *s_amq_server_agent_allow_thread_to_settle_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SERVER_READY))
static icl_stats_t *s_amq_server_agent_report_server_ready_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ACCEPT_CONNECTION))
static icl_stats_t *s_amq_server_agent_accept_connection_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CREATE_CONNECTION_THREAD))
static icl_stats_t *s_amq_server_agent_create_connection_thread_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_ACCEPT_ERROR))
static icl_stats_t *s_amq_server_agent_report_accept_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SMT_ERROR))
static icl_stats_t *s_amq_server_agent_report_smt_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CLOSE_MASTER_SOCKET))
static icl_stats_t *s_amq_server_agent_close_master_socket_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_SETUP_TIMER))
static icl_stats_t *s_amq_server_agent_start_setup_timer_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_PROTOCOL_HEADER))
static icl_stats_t *s_amq_server_agent_read_protocol_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_PROTOCOL_HEADER))
static icl_stats_t *s_amq_server_agent_check_protocol_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DESIRED_HEADER))
static icl_stats_t *s_amq_server_agent_write_desired_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ACCEPT_DIRECT_CONNECTION))
static icl_stats_t *s_amq_server_agent_accept_direct_connection_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_DIRECT_REQUEST))
static icl_stats_t *s_amq_server_agent_read_direct_request_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_DIRECT_LEASE))
static icl_stats_t *s_amq_server_agent_check_direct_lease_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_BAD_PROTOCOL))
static icl_stats_t *s_amq_server_agent_report_bad_protocol_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_VERSION_MISMATCH))
static icl_stats_t *s_amq_server_agent_report_version_mismatch_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_INPUT_THREAD))
static icl_stats_t *s_amq_server_agent_start_input_thread_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_START))
static icl_stats_t *s_amq_server_agent_send_connection_start_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_TUNE))
static icl_stats_t *s_amq_server_agent_send_connection_tune_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_HEARTBEAT_THREAD))
static icl_stats_t *s_amq_server_agent_start_heartbeat_thread_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_HEARTBEAT_TIMER))
static icl_stats_t *s_amq_server_agent_start_heartbeat_timer_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SETUP_TIMEOUT))
static icl_stats_t *s_amq_server_agent_report_setup_timeout_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_FLOW))
static icl_stats_t *s_amq_server_agent_send_channel_flow_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_FLOW_OK))
static icl_stats_t *s_amq_server_agent_send_channel_flow_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_EXCHANGE_DECLARE_OK))
static icl_stats_t *s_amq_server_agent_send_exchange_declare_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_EXCHANGE_DELETE_OK))
static icl_stats_t *s_amq_server_agent_send_exchange_delete_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_DECLARE_OK))
static icl_stats_t *s_amq_server_agent_send_queue_declare_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_BIND_OK))
static icl_stats_t *s_amq_server_agent_send_queue_bind_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_PURGE_OK))
static icl_stats_t *s_amq_server_agent_send_queue_purge_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_DELETE_OK))
static icl_stats_t *s_amq_server_agent_send_queue_delete_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_UNBIND_OK))
static icl_stats_t *s_amq_server_agent_send_queue_unbind_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_QOS_OK))
static icl_stats_t *s_amq_server_agent_send_basic_qos_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_CONSUME_OK))
static icl_stats_t *s_amq_server_agent_send_basic_consume_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_CANCEL_OK))
static icl_stats_t *s_amq_server_agent_send_basic_cancel_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_RETURN))
static icl_stats_t *s_amq_server_agent_send_basic_return_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_DELIVER))
static icl_stats_t *s_amq_server_agent_send_basic_deliver_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_GET_OK))
static icl_stats_t *s_amq_server_agent_send_basic_get_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_GET_EMPTY))
static icl_stats_t *s_amq_server_agent_send_basic_get_empty_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_DIRECT_PUT_OK))
static icl_stats_t *s_amq_server_agent_send_direct_put_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_DIRECT_GET_OK))
static icl_stats_t *s_amq_server_agent_send_direct_get_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_OPEN_OK))
static icl_stats_t *s_amq_server_agent_send_connection_open_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_OPEN_OK))
static icl_stats_t *s_amq_server_agent_send_channel_open_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_CLOSE_OK))
static icl_stats_t *s_amq_server_agent_send_channel_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_PUSH_METHOD_TO_CLIENT))
static icl_stats_t *s_amq_server_agent_push_method_to_client_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_CLOSE))
static icl_stats_t *s_amq_server_agent_send_channel_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONTENT_HEADER))
static icl_stats_t *s_amq_server_agent_send_content_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONTENT_BODY_FRAME))
static icl_stats_t *s_amq_server_agent_send_content_body_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SHUT_DOWN_SLAVE_THREADS))
static icl_stats_t *s_amq_server_agent_shut_down_slave_threads_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_CLOSE))
static icl_stats_t *s_amq_server_agent_send_connection_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_CLOSE))
static icl_stats_t *s_amq_server_agent_execute_connection_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_CLOSE_OK))
static icl_stats_t *s_amq_server_agent_send_connection_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_FLUSH_THE_CONNECTION))
static icl_stats_t *s_amq_server_agent_flush_the_connection_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SOCKET_ERROR))
static icl_stats_t *s_amq_server_agent_report_socket_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SOCKET_TIMEOUT))
static icl_stats_t *s_amq_server_agent_report_socket_timeout_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_HEARTBEAT_FRAME))
static icl_stats_t *s_amq_server_agent_send_heartbeat_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DELIVER_DIRECT_CONTENTS))
static icl_stats_t *s_amq_server_agent_deliver_direct_contents_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DIRECT_CONTENT))
static icl_stats_t *s_amq_server_agent_write_direct_content_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DIRECT_HEARTBEAT))
static icl_stats_t *s_amq_server_agent_write_direct_heartbeat_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_FRAME_HEADER))
static icl_stats_t *s_amq_server_agent_read_frame_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_FRAME_PAYLOAD))
static icl_stats_t *s_amq_server_agent_read_frame_payload_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_FRAME_FORMAT))
static icl_stats_t *s_amq_server_agent_check_frame_format_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DECODE_METHOD))
static icl_stats_t *s_amq_server_agent_decode_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_METHOD_CLASS))
static icl_stats_t *s_amq_server_agent_check_method_class_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_CONNECTION_METHOD))
static icl_stats_t *s_amq_server_agent_check_connection_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_CHANNEL_METHOD))
static icl_stats_t *s_amq_server_agent_check_channel_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_FUNCTIONAL_METHOD))
static icl_stats_t *s_amq_server_agent_execute_functional_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_START_OK))
static icl_stats_t *s_amq_server_agent_execute_connection_start_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_START_OK))
static icl_stats_t *s_amq_server_agent_notify_connection_of_start_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_TUNE_OK))
static icl_stats_t *s_amq_server_agent_execute_connection_tune_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_TUNE_OK))
static icl_stats_t *s_amq_server_agent_notify_connection_of_tune_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_OPEN))
static icl_stats_t *s_amq_server_agent_execute_connection_open_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_OPEN))
static icl_stats_t *s_amq_server_agent_notify_connection_of_open_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_PASSIVE_CLOSE))
static icl_stats_t *s_amq_server_agent_notify_connection_of_passive_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_CLOSE_OK))
static icl_stats_t *s_amq_server_agent_notify_connection_of_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_OPEN))
static icl_stats_t *s_amq_server_agent_execute_channel_open_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_CLOSE))
static icl_stats_t *s_amq_server_agent_execute_channel_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_CLOSE_OK))
static icl_stats_t *s_amq_server_agent_execute_channel_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_FLOW))
static icl_stats_t *s_amq_server_agent_execute_channel_flow_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_FLOW_OK))
static icl_stats_t *s_amq_server_agent_execute_channel_flow_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONTENT_BASIC_HEADER))
static icl_stats_t *s_amq_server_agent_expect_content_basic_header_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_IF_BASIC_BODY_COMPLETE))
static icl_stats_t *s_amq_server_agent_check_if_basic_body_complete_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONTENT_BASIC_BODY))
static icl_stats_t *s_amq_server_agent_expect_content_basic_body_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_EXCEPTION_METHOD))
static icl_stats_t *s_amq_server_agent_expect_exception_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_EXCEPTION))
static icl_stats_t *s_amq_server_agent_notify_connection_of_exception_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_ERROR))
static icl_stats_t *s_amq_server_agent_notify_connection_of_error_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_METHOD_FRAME))
static icl_stats_t *s_amq_server_agent_expect_method_frame_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONNECTION_CLOSE_OK))
static icl_stats_t *s_amq_server_agent_expect_connection_close_ok_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WAIT_FOR_HEARTBEAT_INTERVAL))
static icl_stats_t *s_amq_server_agent_wait_for_heartbeat_interval_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_PEER_LIVENESS))
static icl_stats_t *s_amq_server_agent_check_peer_liveness_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_PEER_SLOWING))
static icl_stats_t *s_amq_server_agent_report_peer_slowing_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SHUT_DOWN_AGENT))
static icl_stats_t *s_amq_server_agent_shut_down_agent_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_PEER_STOPPED))
static icl_stats_t *s_amq_server_agent_report_peer_stopped_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_PASSIVE_CLOSE))
static icl_stats_t *s_amq_server_agent_dialog_call_close_the_connection_passive_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_RETURN))
static icl_stats_t *s_amq_server_agent_dialog_return_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_29))
static icl_stats_t *s_amq_server_agent_unnamed_29_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_30))
static icl_stats_t *s_amq_server_agent_unnamed_30_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_31))
static icl_stats_t *s_amq_server_agent_unnamed_31_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_34))
static icl_stats_t *s_amq_server_agent_unnamed_34_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_ACTIVE_CLOSE))
static icl_stats_t *s_amq_server_agent_dialog_call_close_the_connection_active_close_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_36))
static icl_stats_t *s_amq_server_agent_unnamed_36_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_SEND_CONTENT_BODY_IF_ANY_START))
static icl_stats_t *s_amq_server_agent_dialog_call_send_content_body_if_any_start_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_60))
static icl_stats_t *s_amq_server_agent_unnamed_60_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_70))
static icl_stats_t *s_amq_server_agent_unnamed_70_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_71))
static icl_stats_t *s_amq_server_agent_unnamed_71_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_72))
static icl_stats_t *s_amq_server_agent_unnamed_72_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_73))
static icl_stats_t *s_amq_server_agent_unnamed_73_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_74))
static icl_stats_t *s_amq_server_agent_unnamed_74_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_READ_METHOD_READ_METHOD))
static icl_stats_t *s_amq_server_agent_dialog_call_read_method_read_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CONNECTION_CLOSING_CLOSING))
static icl_stats_t *s_amq_server_agent_dialog_call_connection_closing_closing_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_READ_BASIC_CONTENT_HEADER))
static icl_stats_t *s_amq_server_agent_dialog_call_read_basic_content_header_stats = NULL;
#endif
...
static int    amq_server_agent_manager        (smt_thread_t **thread);
static int    amq_server_agent_catcher        (smt_thread_t *thread);
static int    amq_server_agent_master_destroy  (smt_thread_t *thread);
static int    amq_server_agent_connection_destroy  (smt_thread_t *thread);
static int    amq_server_agent_input_destroy  (smt_thread_t *thread);
static int    amq_server_agent_heartbeat_destroy  (smt_thread_t *thread);
...
#endif
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_SERVER_AGENT)           ||  defined (AMQ_SERVER_AGENT_TRACE))
...
static int    action_send_queue_unbind_ok     (smt_thread_t *thread);
static int    action_send_basic_qos_ok        (smt_thread_t *thread);
static int    action_send_basic_consume_ok    (smt_thread_t *thread);
static int    action_send_basic_cancel_ok     (smt_thread_t *thread);
static int    action_send_basic_return        (smt_thread_t *thread);
...
static int    action_unnamed_60               (smt_thread_t *thread);
static int    action_unnamed_70               (smt_thread_t *thread);
static int    action_unnamed_71               (smt_thread_t *thread);
static int    action_unnamed_72               (smt_thread_t *thread);
static int    action_unnamed_73               (smt_thread_t *thread);
static int    action_unnamed_74               (smt_thread_t *thread);
...
static int
amq_server_agent_set_trace_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    int            trace);
int
amq_server_agent_set_trace_destructor (void *data);
static int
amq_server_agent_connection_error_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          reply_code,
    char *         reply_text,
    ...
    dbyte          faulting_class_id);
int
amq_server_agent_connection_error_destructor (void *data);
static int
amq_server_agent_channel_error_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    amq_server_channel_t *  channel,
    dbyte          reply_code,
    ...
    dbyte          faulting_class_id);
int
amq_server_agent_channel_error_destructor (void *data);
static int
amq_server_agent_channel_flow_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    Bool           active);
int
amq_server_agent_channel_flow_destructor (void *data);
static int
amq_server_agent_channel_flow_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    Bool           active);
int
amq_server_agent_channel_flow_ok_destructor (void *data);
static int
amq_server_agent_exchange_declare_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_server_agent_exchange_declare_ok_destructor (void *data);
static int
amq_server_agent_exchange_delete_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_server_agent_exchange_delete_ok_destructor (void *data);
static int
amq_server_agent_queue_declare_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         queue,
    ...
    qbyte          consumer_count);
int
amq_server_agent_queue_declare_ok_destructor (void *data);
static int
amq_server_agent_queue_bind_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_server_agent_queue_bind_ok_destructor (void *data);
static int
amq_server_agent_queue_purge_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    qbyte          message_count);
int
amq_server_agent_queue_purge_ok_destructor (void *data);
static int
amq_server_agent_queue_delete_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    qbyte          message_count);
int
amq_server_agent_queue_delete_ok_destructor (void *data);
static int
amq_server_agent_queue_unbind_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_server_agent_queue_unbind_ok_destructor (void *data);
static int
amq_server_agent_basic_qos_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr);
int
amq_server_agent_basic_qos_ok_destructor (void *data);
static int
amq_server_agent_basic_consume_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         consumer_tag);
int
amq_server_agent_basic_consume_ok_destructor (void *data);
static int
amq_server_agent_basic_cancel_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         consumer_tag);
int
amq_server_agent_basic_cancel_ok_destructor (void *data);
static int
amq_server_agent_basic_return_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_content_basic_t *  content,
    ...
    void *         callback);
int
amq_server_agent_basic_return_destructor (void *data);
static int
amq_server_agent_basic_deliver_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_content_basic_t *  content,
    ...
    void *         callback);
int
amq_server_agent_basic_deliver_destructor (void *data);
static int
amq_server_agent_basic_get_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_content_basic_t *  content,
    ...
    void *         callback);
int
amq_server_agent_basic_get_ok_destructor (void *data);
static int
amq_server_agent_basic_get_empty_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         sender_id);
int
amq_server_agent_basic_get_empty_destructor (void *data);
static int
amq_server_agent_direct_put_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         lease);
int
amq_server_agent_direct_put_ok_destructor (void *data);
static int
amq_server_agent_direct_get_ok_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    char *         lease);
int
amq_server_agent_direct_get_ok_destructor (void *data);
static int
amq_server_agent_push_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    dbyte          channel_nbr,
    amq_server_method_t *  method);
int
amq_server_agent_push_destructor (void *data);
static int
amq_server_agent_direct_out_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    amq_content_basic_t *  content,
    byte           options);
int
amq_server_agent_direct_out_destructor (void *data);
    ...
    int            trace)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          amq_server_agent_set_trace_destructor);
...
int trace;
    ...
    trace = ((amq_server_agent_set_trace_t *) data)-> trace;
    ...
    dbyte          faulting_class_id)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_connection_error_destructor);
...
dbyte faulting_class_id;
    ...
    reply_code = ((amq_server_agent_connection_error_t *) data)-> reply_code;
    reply_text = ((amq_server_agent_connection_error_t *) data)-> reply_text;
    faulting_method_id = ((amq_server_agent_connection_error_t *) data)-> faulting_method_id;
    faulting_class_id = ((amq_server_agent_connection_error_t *) data)-> faulting_class_id;
    ...
    dbyte          faulting_class_id)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_channel_error_destructor);
...
dbyte faulting_class_id;
    ...
    channel = ((amq_server_agent_channel_error_t *) data)-> channel;
    reply_code = ((amq_server_agent_channel_error_t *) data)-> reply_code;
    reply_text = ((amq_server_agent_channel_error_t *) data)-> reply_text;
    faulting_method_id = ((amq_server_agent_channel_error_t *) data)-> faulting_method_id;
    faulting_class_id = ((amq_server_agent_channel_error_t *) data)-> faulting_class_id;
    ...
    Bool           active)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_channel_flow_destructor);
...
Bool active;
    ...
    channel_nbr = ((amq_server_agent_channel_flow_t *) data)-> channel_nbr;
    active = ((amq_server_agent_channel_flow_t *) data)-> active;
    ...
    Bool           active)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_channel_flow_ok_destructor);
...
Bool active;
    ...
    channel_nbr = ((amq_server_agent_channel_flow_ok_t *) data)-> channel_nbr;
    active = ((amq_server_agent_channel_flow_ok_t *) data)-> active;
    ...
    dbyte          channel_nbr)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_exchange_declare_ok_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_server_agent_exchange_declare_ok_t *) data)-> channel_nbr;
    ...
    dbyte          channel_nbr)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_exchange_delete_ok_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_server_agent_exchange_delete_ok_t *) data)-> channel_nbr;
    ...
    qbyte          consumer_count)
{
    ...
    _message->consumer_count            = consumer_count;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_queue_declare_ok_destructor);
...
qbyte consumer_count;
    ...
    channel_nbr = ((amq_server_agent_queue_declare_ok_t *) data)-> channel_nbr;
    queue = ((amq_server_agent_queue_declare_ok_t *) data)-> queue;
    message_count = ((amq_server_agent_queue_declare_ok_t *) data)-> message_count;
    consumer_count = ((amq_server_agent_queue_declare_ok_t *) data)-> consumer_count;
    ...
    dbyte          channel_nbr)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_queue_bind_ok_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_server_agent_queue_bind_ok_t *) data)-> channel_nbr;
    ...
    qbyte          message_count)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_queue_purge_ok_destructor);
...
qbyte message_count;
    ...
    channel_nbr = ((amq_server_agent_queue_purge_ok_t *) data)-> channel_nbr;
    message_count = ((amq_server_agent_queue_purge_ok_t *) data)-> message_count;
    ...
    qbyte          message_count)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_queue_delete_ok_destructor);
...
qbyte message_count;
    ...
    channel_nbr = ((amq_server_agent_queue_delete_ok_t *) data)-> channel_nbr;
    message_count = ((amq_server_agent_queue_delete_ok_t *) data)-> message_count;
    ...
    dbyte          channel_nbr)
{
    ...
    //  Possess code for queue unbind-ok
    

    _message = icl_mem_cache_alloc (s_queue_unbind_ok_cache);
    _message->channel_nbr               = channel_nbr;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_queue_unbind_ok_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_server_agent_queue_unbind_ok_t *) data)-> channel_nbr;
    ...
    dbyte          channel_nbr)
{
    ...
    //  Possess code for basic qos-ok
    

    _message = icl_mem_cache_alloc (s_basic_qos_ok_cache);
    _message->channel_nbr               = channel_nbr;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_qos_ok_destructor);
...
dbyte channel_nbr;
    ...
    channel_nbr = ((amq_server_agent_basic_qos_ok_t *) data)-> channel_nbr;
    ...
    char *         consumer_tag)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_consume_ok_destructor);
...
char * consumer_tag;
    ...
    channel_nbr = ((amq_server_agent_basic_consume_ok_t *) data)-> channel_nbr;
    consumer_tag = ((amq_server_agent_basic_consume_ok_t *) data)-> consumer_tag;
    ...
    char *         consumer_tag)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_cancel_ok_destructor);
...
char * consumer_tag;
    ...
    channel_nbr = ((amq_server_agent_basic_cancel_ok_t *) data)-> channel_nbr;
    consumer_tag = ((amq_server_agent_basic_cancel_ok_t *) data)-> consumer_tag;
    ...
    void *         callback)
{
    ...
    //  Possess code for basic return
    
        assert (content);
        content  = amq_content_basic_link (content);
        reply_text = icl_mem_strdup (reply_text);
        exchange = icl_mem_strdup (exchange);
        routing_key = icl_mem_strdup (routing_key);
    

    _message = icl_mem_cache_alloc (s_basic_return_cache);
    _message->channel_nbr               = channel_nbr;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_return_destructor);
...
void * callback;
    ...
    channel_nbr = ((amq_server_agent_basic_return_t *) data)-> channel_nbr;
    content = ((amq_server_agent_basic_return_t *) data)-> content;
    reply_code = ((amq_server_agent_basic_return_t *) data)-> reply_code;
    reply_text = ((amq_server_agent_basic_return_t *) data)-> reply_text;
    exchange = ((amq_server_agent_basic_return_t *) data)-> exchange;
    routing_key = ((amq_server_agent_basic_return_t *) data)-> routing_key;
    callback = ((amq_server_agent_basic_return_t *) data)-> callback;


        amq_content_basic_unlink (&content);
        icl_mem_free (reply_text);
    ...
    void *         callback)
{
    ...
    _message->redelivered               = redelivered;
    _message->exchange                  = exchange;
    _message->routing_key               = routing_key;
    _message->callback                  = callback;
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_deliver_destructor);
...
void * callback;
    ...
    channel_nbr = ((amq_server_agent_basic_deliver_t *) data)-> channel_nbr;
    content = ((amq_server_agent_basic_deliver_t *) data)-> content;
    consumer_tag = ((amq_server_agent_basic_deliver_t *) data)-> consumer_tag;
    delivery_tag = ((amq_server_agent_basic_deliver_t *) data)-> delivery_tag;
    redelivered = ((amq_server_agent_basic_deliver_t *) data)-> redelivered;
    exchange = ((amq_server_agent_basic_deliver_t *) data)-> exchange;
    routing_key = ((amq_server_agent_basic_deliver_t *) data)-> routing_key;
    callback = ((amq_server_agent_basic_deliver_t *) data)-> callback;
    ...
    void *         callback)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_get_ok_destructor);
...
void * callback;
    ...
    channel_nbr = ((amq_server_agent_basic_get_ok_t *) data)-> channel_nbr;
    content = ((amq_server_agent_basic_get_ok_t *) data)-> content;
    delivery_tag = ((amq_server_agent_basic_get_ok_t *) data)-> delivery_tag;
    redelivered = ((amq_server_agent_basic_get_ok_t *) data)-> redelivered;
    exchange = ((amq_server_agent_basic_get_ok_t *) data)-> exchange;
    routing_key = ((amq_server_agent_basic_get_ok_t *) data)-> routing_key;
    message_count = ((amq_server_agent_basic_get_ok_t *) data)-> message_count;
    callback = ((amq_server_agent_basic_get_ok_t *) data)-> callback;
    ...
    char *         sender_id)
{
    ...
    //  Possess code for basic get-empty
        ...
        sender_id = icl_mem_strdup (sender_id);
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_basic_get_empty_destructor);
...
char * sender_id;
    ...
    channel_nbr = ((amq_server_agent_basic_get_empty_t *) data)-> channel_nbr;
    sender_id = ((amq_server_agent_basic_get_empty_t *) data)-> sender_id;


        icl_mem_free (sender_id);
    ...
    char *         lease)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_direct_put_ok_destructor);
...
char * lease;
    ...
    channel_nbr = ((amq_server_agent_direct_put_ok_t *) data)-> channel_nbr;
    lease = ((amq_server_agent_direct_put_ok_t *) data)-> lease;
    ...
    char *         lease)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_direct_get_ok_destructor);
...
char * lease;
    ...
    channel_nbr = ((amq_server_agent_direct_get_ok_t *) data)-> channel_nbr;
    lease = ((amq_server_agent_direct_get_ok_t *) data)-> lease;
    ...
    amq_server_method_t *  method)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_push_destructor);
...
amq_server_method_t * method;
    ...
    channel_nbr = ((amq_server_agent_push_t *) data)-> channel_nbr;
    method = ((amq_server_agent_push_t *) data)-> method;
    ...
    byte           options)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_server_agent_direct_out_destructor);
...
byte options;
    ...
    content = ((amq_server_agent_direct_out_t *) data)-> content;
    options = ((amq_server_agent_direct_out_t *) data)-> options;
    ...
    smt_thread_t * thread)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = smt_method_send (
                thread->reply_queue,
    ...
    int                   trace)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_set_trace_send (
    ...
    dbyte                 faulting_class_id)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_connection_error_send (
    ...
    dbyte                 faulting_class_id)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_channel_error_send (
    ...
    Bool                  active)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_channel_flow_send (
    ...
    Bool                  active)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_channel_flow_ok_send (
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_exchange_declare_ok_send (
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_exchange_delete_ok_send (
    ...
    qbyte                 consumer_count)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_queue_declare_ok_send (
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_queue_bind_ok_send (
    ...
    qbyte                 message_count)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_queue_purge_ok_send (
    ...
    qbyte                 message_count)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_queue_delete_ok_send (
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_queue_unbind_ok_send (
                thread->reply_queue, queue_unbind_ok_m_event,
                channel_nbr);
    }
    else
        rc = -1;
    ...
    dbyte                 channel_nbr)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_qos_ok_send (
                thread->reply_queue, basic_qos_ok_m_event,
                channel_nbr);
    }
    else
        rc = -1;
    ...
    char *                consumer_tag)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_consume_ok_send (
    ...
    char *                consumer_tag)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_cancel_ok_send (
    ...
    void *                callback)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_return_send (
                thread->reply_queue, basic_return_m_event,
                channel_nbr,
                content,
                reply_code,
                reply_text,
    ...
    void *                callback)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_deliver_send (
    ...
    void *                callback)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_get_ok_send (
    ...
    char *                sender_id)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_basic_get_empty_send (
    ...
    char *                lease)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_direct_put_ok_send (
    ...
    char *                lease)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_direct_get_ok_send (
    ...
    byte                  options)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_server_agent_manager);
        rc = amq_server_agent_direct_out_send (
...
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
    ...
    dbyte faulting_method_id)           //  Faulting method id, if any
{
    ...
    amq_server_connection_raise_exception (tcb->connection,
    ...
    )
{
    ...
    if (amq_server_connection_exception_raised (tcb->connection))
    ...
    &&  tcb->method_in->method_id == method_id) {
        amq_server_method_execute (tcb->method_in, tcb->connection,
    ...
    smt_log_t *log)
{
    ...
    if (tcb->trace >= ASL_TRACE_LOW)
        amq_server_method_dump (tcb->method_out, log, "I: send ");

    //  Send the method
    payload = amq_server_method_encode (tcb->method_out);
    ...
    smt_thread_t ** thread_p)
{
    ...
    s_connection_context_cache = icl_cache_get (sizeof (amq_server_agent_connection_context_t));
    s_master_context_cache = icl_cache_get (sizeof (amq_server_agent_master_context_t));
    s_set_trace_cache = icl_cache_get (sizeof (amq_server_agent_set_trace_t));
    s_connection_error_cache = icl_cache_get (sizeof (amq_server_agent_connection_error_t));
    s_channel_error_cache = icl_cache_get (sizeof (amq_server_agent_channel_error_t));
    s_channel_flow_cache = icl_cache_get (sizeof (amq_server_agent_channel_flow_t));
    s_channel_flow_ok_cache = icl_cache_get (sizeof (amq_server_agent_channel_flow_ok_t));
    s_exchange_declare_ok_cache = icl_cache_get (sizeof (amq_server_agent_exchange_declare_ok_t));
    s_exchange_delete_ok_cache = icl_cache_get (sizeof (amq_server_agent_exchange_delete_ok_t));
    s_queue_declare_ok_cache = icl_cache_get (sizeof (amq_server_agent_queue_declare_ok_t));
    s_queue_bind_ok_cache = icl_cache_get (sizeof (amq_server_agent_queue_bind_ok_t));
    s_queue_purge_ok_cache = icl_cache_get (sizeof (amq_server_agent_queue_purge_ok_t));
    s_queue_delete_ok_cache = icl_cache_get (sizeof (amq_server_agent_queue_delete_ok_t));
    s_queue_unbind_ok_cache = icl_cache_get (sizeof (amq_server_agent_queue_unbind_ok_t));
    s_basic_qos_ok_cache = icl_cache_get (sizeof (amq_server_agent_basic_qos_ok_t));
    s_basic_consume_ok_cache = icl_cache_get (sizeof (amq_server_agent_basic_consume_ok_t));
    s_basic_cancel_ok_cache = icl_cache_get (sizeof (amq_server_agent_basic_cancel_ok_t));
    s_basic_return_cache = icl_cache_get (sizeof (amq_server_agent_basic_return_t));
    s_basic_deliver_cache = icl_cache_get (sizeof (amq_server_agent_basic_deliver_t));
    s_basic_get_ok_cache = icl_cache_get (sizeof (amq_server_agent_basic_get_ok_t));
    s_basic_get_empty_cache = icl_cache_get (sizeof (amq_server_agent_basic_get_empty_t));
    s_direct_put_ok_cache = icl_cache_get (sizeof (amq_server_agent_direct_put_ok_t));
    s_direct_get_ok_cache = icl_cache_get (sizeof (amq_server_agent_direct_get_ok_t));
    s_push_cache = icl_cache_get (sizeof (amq_server_agent_push_t));
    s_direct_out_cache = icl_cache_get (sizeof (amq_server_agent_direct_out_t));
    ...
    rc = SMT_OK;
    if (amq_server_config_trace (amq_server_config) >= ASL_TRACE_HIGH)
    ...
    *thread_p = thread;
    ...
    icl_system_register (NULL, amq_server_agent_term);
    
    return rc;
}

void
amq_server_agent_animate (Bool animate)
{
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_SERVER_AGENT))
    s_animate = animate;
#endif
...
smt_thread_t *
amq_server_agent_master_thread_new (void)
{
    smt_thread_t
        *thread;

    thread = smt_thread_new (amq_server_agent_manager,
                             amq_server_agent_catcher,
                             amq_server_agent_master_destroy);
                             
    thread->schedule = SMT_SCHEDULE_POLL;

#if (defined (AMQ_SERVER_AGENT_TRACE))
    ...
    if (thread) {
        ...
        memset (thread->context, 0, sizeof (amq_server_agent_master_context_t));
        ((amq_server_agent_master_context_t *) thread->context)->links = 1;
        thread->event_name = event_name;
{
#define tcb ((amq_server_agent_master_context_t *) thread->context)
...
smt_thread_t *
amq_server_agent_connection_thread_new (void)
{
    smt_thread_t
        *thread;
    ...
    thread = smt_thread_new (amq_server_agent_manager,
                             amq_server_agent_catcher,
                             amq_server_agent_connection_destroy);
    ...
    if (thread) {
        ...
        memset (thread->context, 0, sizeof (amq_server_agent_connection_context_t));
        ((amq_server_agent_connection_context_t *) thread->context)->links = 1;
        thread->event_name = event_name;
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
smt_thread_t *
amq_server_agent_input_thread_new (
    smt_thread_t * share)
{
    smt_thread_t
        *thread;
    ...
    thread = smt_thread_new (amq_server_agent_manager,
                             amq_server_agent_catcher,
                             amq_server_agent_input_destroy);
...
smt_thread_t *
amq_server_agent_heartbeat_thread_new (
    smt_thread_t * share)
{
    smt_thread_t
        *thread;
    ...
    thread = smt_thread_new (amq_server_agent_manager,
                             amq_server_agent_catcher,
                             amq_server_agent_heartbeat_destroy);
...
static int
amq_server_agent_manager (smt_thread_t **thread_p)
{
    smt_thread_t
        *thread = *thread_p;
...
#define tcb ((amq_server_agent_master_context_t *) thread->context)
        ...
        if (amq_server_config_trace (amq_server_config) >= ASL_TRACE_MED)
            thread->animate = TRUE;
...
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
        ...
        //  Create amq_server_connection object
        tcb->connection = amq_server_connection_new (
            amq_broker->connections, thread);
        amq_server_connection_list_push (
            amq_broker->connection_list,
            tcb->connection);
        ...
        amq_server_connection_set_address (tcb->connection, address_full);
...
#undef  tcb
        ...
        if (thread->place < 112)                //  Connection Active state
            thread->place = 73;
        else
        if (thread->place < 128)                //  Send Content Body If Any state
            thread->place = 112;
        else
        if (thread->place == 128) { //              Input thread
            if (!thread->shutting_down) {
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
        ...
        if (thread->place < 139)                //  Start state
            thread->place = 129;
        else
        if (thread->place < 149)                //  Read Method state
            thread->place = 139;
        else
        if (thread->place < 162)                //  Connection Closing state
            thread->place = 149;
        else
        if (thread->place < 176)                //  Have Incoming Method state
            thread->place = 162;
        else
        if (thread->place < 190)                //  Have Connection Method state
            thread->place = 176;
        else
        if (thread->place < 204)                //  Have Channel Method state
            thread->place = 190;
        else
        if (thread->place < 216)                //  Read Basic Content state
            thread->place = 204;
        else
        if (thread->place == 216) { //              Heartbeat thread
            if (!thread->shutting_down) {
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
            ...
            switch (thread->_next_event) {
                ...
                case ok_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 112:                       //  send content body if any state      
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 149:                       //  connection closing state            
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 162:                       //  have incoming method state          
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 176:                       //  have connection method state        
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 190:                       //  have channel method state           
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 204:                       //  read basic content state            
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 7);
            ...
            break;
        case 217:                       //  monitor heartbeat state             
{
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
...
#undef  tcb
    ...
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + laststate + 79);
#endif
#if (defined (AMQ_SERVER_AGENT_TRACE))
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 79);
#endif
                    thread->place = 218; break;
                case peer_slowing_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + laststate + 80);
#endif
#if (defined (AMQ_SERVER_AGENT_TRACE))
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 80);
#endif
                    thread->place = 219; break;
                case peer_stopped_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + laststate + 81);
#endif
#if (defined (AMQ_SERVER_AGENT_TRACE))
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (thread->trace, s_dump, thread->id * 0x10000 + laststate + 81);
#endif
                    thread->place = 220; break;
                case smt_error_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 15);
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + laststate + 5);
...
#endif
                    rc = action_send_queue_unbind_ok (thread);
...
#endif
                    rc = action_send_basic_qos_ok (thread);
...
#endif
                    rc = action_send_basic_return (thread);
...
static int
amq_server_agent_catcher (smt_thread_t *thread)
{
...
static int    
amq_server_agent_master_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
...
#undef  tcb
    ...
    if (--((amq_server_agent_master_context_t *) thread->context)->links == 0)
...
static int    
amq_server_agent_connection_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    //  Don't trust thread->os_thread while destroying thread.
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 0);
...
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
        ...
        //  Destroy amq_server_connection object
        amq_server_connection_destroy (&tcb->connection);

        //  Free resources
        amq_lease_unlink (&tcb->lease);
        amq_server_method_unlink (&tcb->method_in);
        amq_server_method_unlink (&tcb->method_out);
        amq_server_channel_destroy (&tcb->channel);
        ipr_bucket_unlink (&tcb->bucket_in);
        smt_socket_destroy (&tcb->socket);
    
#undef  tcb
}
    if (--((amq_server_agent_connection_context_t *) thread->context)->links == 0)
        icl_mem_free (thread->context);
    return 0;
}
...
static int    
amq_server_agent_input_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    //  Don't trust thread->os_thread while destroying thread.
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 0);
...
static int    
amq_server_agent_heartbeat_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_SERVER_AGENT))
    //  Don't trust thread->os_thread while destroying thread.
    icl_trace_record (NULL, s_dump, thread->id * 0x10000 + 0);
        ...
        if (thread->place < 112)
          {
            *state_id = 6;
            switch (thread->place) {
                ...
                case 86: *event_id = 43;   *nextstate_id = 6;   break;
                case 87: *event_id = 44;   *nextstate_id = 6;   break;
                ...
                case 95: *event_id = 55;   *nextstate_id = 6;   break;
                case 96: *event_id = 56;   *nextstate_id = 6;   break;
                case 97: *event_id = 57;   *nextstate_id = 6;   break;
                case 98: *event_id = 6;   break;
                case 99: *event_id = 58;   *nextstate_id = 6;   break;
                case 100: *event_id = 4;   break;
                case 101: *event_id = 14;   break;
                case 102: *event_id = 12;   break;
                case 103: *event_id = 5;   break;
                case 104: *event_id = 15;   break;
                case 105: *event_id = 19;   break;
                case 106: *event_id = 21;   break;
                case 107: *event_id = 22;   break;
                case 108: *event_id = 11;   *nextstate_id = 6;   break;
                case 109: *event_id = 23;   *nextstate_id = 6;   break;
                case 110: *event_id = 24;   *nextstate_id = 6;   break;
                case 111: *event_id = 7;   break;
            }
          }
        else
          {
            *state_id = 7;
            switch (thread->place) {
                case 113: *event_id = 45;   *nextstate_id = 7;   break;
                case 114: *event_id = 46;   *nextstate_id = 7;   break;
                case 115: *event_id = 47;   *nextstate_id = 7;   break;
                case 116: *event_id = 4;   break;
                case 117: *event_id = 14;   break;
                case 118: *event_id = 12;   break;
                case 119: *event_id = 5;   break;
                case 120: *event_id = 15;   break;
                case 121: *event_id = 19;   break;
                case 122: *event_id = 21;   break;
                case 123: *event_id = 22;   break;
                case 124: *event_id = 11;   *nextstate_id = 7;   break;
                case 125: *event_id = 23;   *nextstate_id = 7;   break;
                case 126: *event_id = 24;   *nextstate_id = 7;   break;
                case 127: *event_id = 7;   break;
            }
          }
      }
    else
        ...
        if (thread->place < 139)
          {
            *state_id = 8;
            switch (thread->place) {
                case 130: *event_id = 1;   *nextstate_id = 11;   break;
                case 131: *event_id = 4;   break;
                case 132: *event_id = 14;   break;
                case 133: *event_id = 12;   break;
                case 134: *event_id = 5;   break;
                case 135: *event_id = 21;   break;
                case 136: *event_id = 19;   break;
                case 137: *event_id = 64;   break;
                case 138: *event_id = 7;   break;
            }
          }
        else
        if (thread->place < 149)
          {
            *state_id = 9;
            switch (thread->place) {
                case 140: *event_id = 59;   *nextstate_id = 9;   break;
                case 141: *event_id = 4;   break;
                case 142: *event_id = 14;   break;
                case 143: *event_id = 12;   break;
                case 144: *event_id = 5;   break;
                case 145: *event_id = 21;   break;
                case 146: *event_id = 19;   break;
                case 147: *event_id = 64;   break;
                case 148: *event_id = 7;   break;
            }
          }
        else
        if (thread->place < 162)
          {
            *state_id = 10;
            switch (thread->place) {
                case 150: *event_id = 60;   *nextstate_id = 10;   break;
                case 151: *event_id = 61;   *nextstate_id = 10;   break;
                case 152: *event_id = 62;   *nextstate_id = 10;   break;
                case 153: *event_id = 63;   break;
                case 154: *event_id = 19;   break;
                case 155: *event_id = 4;   break;
                case 156: *event_id = 14;   break;
                case 157: *event_id = 12;   break;
                case 158: *event_id = 5;   break;
                case 159: *event_id = 21;   break;
                case 160: *event_id = 64;   break;
                case 161: *event_id = 7;   break;
            }
          }
        else
        if (thread->place < 176)
          {
            *state_id = 11;
            switch (thread->place) {
                case 163: *event_id = 65;   *nextstate_id = 12;   break;
                case 164: *event_id = 69;   *nextstate_id = 13;   break;
                case 165: *event_id = 75;   *nextstate_id = 11;   break;
                case 166: *event_id = 78;   *nextstate_id = 11;   break;
                case 167: *event_id = 31;   *nextstate_id = 11;   break;
                case 168: *event_id = 4;   break;
                case 169: *event_id = 14;   break;
                case 170: *event_id = 12;   break;
                case 171: *event_id = 5;   break;
                case 172: *event_id = 21;   break;
                case 173: *event_id = 19;   break;
                case 174: *event_id = 64;   break;
                case 175: *event_id = 7;   break;
            }
          }
        else
        if (thread->place < 190)
          {
            *state_id = 12;
            switch (thread->place) {
                case 177: *event_id = 66;   *nextstate_id = 11;   break;
                case 178: *event_id = 67;   *nextstate_id = 11;   break;
                case 179: *event_id = 68;   *nextstate_id = 11;   break;
                case 180: *event_id = 15;   break;
                case 181: *event_id = 63;   break;
                case 182: *event_id = 4;   break;
                case 183: *event_id = 14;   break;
                case 184: *event_id = 12;   break;
                case 185: *event_id = 5;   break;
                case 186: *event_id = 21;   break;
                case 187: *event_id = 19;   break;
                case 188: *event_id = 64;   break;
                case 189: *event_id = 7;   break;
            }
          }
        else
        if (thread->place < 204)
          {
            *state_id = 13;
            switch (thread->place) {
                ...
                case 193: *event_id = 72;   *nextstate_id = 11;   break;
                case 194: *event_id = 73;   *nextstate_id = 11;   break;
                case 195: *event_id = 74;   *nextstate_id = 11;   break;
                case 196: *event_id = 4;   break;
                case 197: *event_id = 14;   break;
                case 198: *event_id = 12;   break;
                case 199: *event_id = 5;   break;
                case 200: *event_id = 21;   break;
                case 201: *event_id = 19;   break;
                case 202: *event_id = 64;   break;
                case 203: *event_id = 7;   break;
            }
          }
        else
          {
            *state_id = 14;
            switch (thread->place) {
                case 205: *event_id = 76;   *nextstate_id = 14;   break;
                case 206: *event_id = 77;   *nextstate_id = 14;   break;
                case 207: *event_id = 61;   *nextstate_id = 11;   break;
                case 208: *event_id = 4;   break;
                case 209: *event_id = 14;   break;
                case 210: *event_id = 12;   break;
                case 211: *event_id = 5;   break;
                case 212: *event_id = 21;   break;
                case 213: *event_id = 19;   break;
                case 214: *event_id = 64;   break;
                case 215: *event_id = 7;   break;
            }
          }
      }
    else
        ...
        *thread_type = 4;
          {
            *state_id = 15;
            switch (thread->place) {
                case 218: *event_id = 79;   *nextstate_id = 15;   break;
                case 219: *event_id = 80;   *nextstate_id = 15;   break;
                case 220: *event_id = 81;   break;
                case 221: *event_id = 5;   break;
                case 222: *event_id = 7;   break;
            }
          }
      }
}
...
report_unrecognised_event_error (smt_thread_t *thread)
{
    ...
    icl_console_print ("amq_server_agent: Unrecognised event '%s' in '%s' thread number: %u, state: %s",
                       event_name_or_number,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_INITIALISE_SERVER))
    icl_stats_inc ("amq_server_agent_initialise_server", &s_amq_server_agent_initialise_server_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
        ...
        port  = amq_server_config_port   (amq_server_config);
        user  = amq_server_config_user   (amq_server_config);
        group = amq_server_config_group (amq_server_config);
        if (atoi (port) < 1024
        ||  atoi (port) > 65535) {
            smt_log_print (amq_broker->alert_log,
            ...
            icl_shortstr_cpy (hostname, amq_server_config_listen (amq_server_config));
            if (streq (hostname, "*")) {
                smt_log_print (amq_broker->alert_log,
            ...
            if (sockaddr) {
                apr_sockaddr_ip_get (&address, sockaddr);
                icl_shortstr_fmt (amq_broker->host, "%s:%s", address, port);
            }
            else
                smt_log_print (amq_broker->alert_log,
                    "E: cannot translate host name '%s'", hostname);
            ...
            if (tcb->master_socket) {
                ...
                rc = smt_socket_set_nodelay (tcb->master_socket,
                    amq_server_config_tcp_nodelay (amq_server_config));
                if (rc)
                    smt_log_print (amq_broker->alert_log,
                ...
                new_size = amq_server_config_tcp_rcvbuf (amq_server_config);
                if (new_size) {
                ...
                new_size = amq_server_config_tcp_sndbuf (amq_server_config);
                if (new_size) {
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ALLOW_THREAD_TO_SETTLE))
    icl_stats_inc ("amq_server_agent_allow_thread_to_settle", &s_amq_server_agent_allow_thread_to_settle_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SERVER_READY))
    icl_stats_inc ("amq_server_agent_report_server_ready", &s_amq_server_agent_report_server_ready_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{

        smt_log_print (amq_broker->alert_log,
            "I: server ready for incoming AMQ connections");
        if (amq_server_config_direct (amq_server_config))
            smt_log_print (amq_broker->alert_log,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ACCEPT_CONNECTION))
    icl_stats_inc ("amq_server_agent_accept_connection", &s_amq_server_agent_accept_connection_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CREATE_CONNECTION_THREAD))
    icl_stats_inc ("amq_server_agent_create_connection_thread", &s_amq_server_agent_create_connection_thread_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
        ...
        connection_thread = amq_server_agent_connection_thread_new ();
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_ACCEPT_ERROR))
    icl_stats_inc ("amq_server_agent_report_accept_error", &s_amq_server_agent_report_accept_error_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
        ...
        if (thread->result == SMT_SOCKET_ERROR &&
           (APR_STATUS_IS_ENFILE(thread->error) ||
            ...
            accept_retry_timeout =
                amq_server_config_accept_retry_timeout (amq_server_config);
            smt_log_print (amq_broker->alert_log,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SMT_ERROR))
    icl_stats_inc ("amq_server_agent_report_smt_error", &s_amq_server_agent_report_smt_error_stats);
#endif        
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CLOSE_MASTER_SOCKET))
    icl_stats_inc ("amq_server_agent_close_master_socket", &s_amq_server_agent_close_master_socket_stats);
#endif        
#define tcb ((amq_server_agent_master_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_SETUP_TIMER))
    icl_stats_inc ("amq_server_agent_start_setup_timer", &s_amq_server_agent_start_setup_timer_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        tcb->setup_timer = smt_timer_request_delay (thread,
            amq_server_config_setup_timeout (amq_server_config) * 1000 * 1000,
            setup_timeout_event);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_PROTOCOL_HEADER))
    icl_stats_inc ("amq_server_agent_read_protocol_header", &s_amq_server_agent_read_protocol_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        assert (strlen ("AMQP") == 4);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_PROTOCOL_HEADER))
    icl_stats_inc ("amq_server_agent_check_protocol_header", &s_amq_server_agent_check_protocol_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        //  Check the first 4 bytes are "AMQP"
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DESIRED_HEADER))
    icl_stats_inc ("amq_server_agent_write_desired_header", &s_amq_server_agent_write_desired_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        //  Write our own protocol header to the socket
        s_socket_write (thread, (byte *) "AMQP\x00\x00\x09\x01", 8);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_ACCEPT_DIRECT_CONNECTION))
    icl_stats_inc ("amq_server_agent_accept_direct_connection", &s_amq_server_agent_accept_direct_connection_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        tcb->batching = amq_server_config_batching (amq_server_config);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_DIRECT_REQUEST))
    icl_stats_inc ("amq_server_agent_read_direct_request", &s_amq_server_agent_read_direct_request_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_DIRECT_LEASE))
    icl_stats_inc ("amq_server_agent_check_direct_lease", &s_amq_server_agent_check_direct_lease_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        tcb->lease = amq_lease_search (tcb->request);
        if (tcb->lease) {
            tcb->type = tcb->lease->type;
            if (amq_lease_acquire (tcb->lease, thread, tcb->socket)) {
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_BAD_PROTOCOL))
    icl_stats_inc ("amq_server_agent_report_bad_protocol", &s_amq_server_agent_report_bad_protocol_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_VERSION_MISMATCH))
    icl_stats_inc ("amq_server_agent_report_version_mismatch", &s_amq_server_agent_report_version_mismatch_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_INPUT_THREAD))
    icl_stats_inc ("amq_server_agent_start_input_thread", &s_amq_server_agent_start_input_thread_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        //  Start input thread
        input_thread = amq_server_agent_input_thread_new (thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_START))
    icl_stats_inc ("amq_server_agent_send_connection_start", &s_amq_server_agent_send_connection_start_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        asl_field_new_string (field_list, "host", amq_broker->host);
        asl_field_new_string (field_list, "product", "OpenAMQ Server");
        ...
        asl_field_new_string (field_list, "identifier", amq_broker->identifier);
        asl_field_new_integer (field_list, "direct", amq_server_config_direct (amq_server_config));
        ...
        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_connection_start (
            0, 9, properties, mechanisms,
            locales);
        s_send_method_out (thread, 0, amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_TUNE))
    icl_stats_inc ("amq_server_agent_send_connection_tune", &s_amq_server_agent_send_connection_tune_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_connection_tune (
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_HEARTBEAT_THREAD))
    icl_stats_inc ("amq_server_agent_start_heartbeat_thread", &s_amq_server_agent_start_heartbeat_thread_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->heartbeat) {
            heartbeat_thread = amq_server_agent_heartbeat_thread_new (thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_START_HEARTBEAT_TIMER))
    icl_stats_inc ("amq_server_agent_start_heartbeat_timer", &s_amq_server_agent_start_heartbeat_timer_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SETUP_TIMEOUT))
    icl_stats_inc ("amq_server_agent_report_setup_timeout", &s_amq_server_agent_report_setup_timeout_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_FLOW))
    icl_stats_inc ("amq_server_agent_send_channel_flow", &s_amq_server_agent_send_channel_flow_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_FLOW_OK))
    icl_stats_inc ("amq_server_agent_send_channel_flow_ok", &s_amq_server_agent_send_channel_flow_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_EXCHANGE_DECLARE_OK))
    icl_stats_inc ("amq_server_agent_send_exchange_declare_ok", &s_amq_server_agent_send_exchange_declare_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_EXCHANGE_DELETE_OK))
    icl_stats_inc ("amq_server_agent_send_exchange_delete_ok", &s_amq_server_agent_send_exchange_delete_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_DECLARE_OK))
    icl_stats_inc ("amq_server_agent_send_queue_declare_ok", &s_amq_server_agent_send_queue_declare_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            tcb->method_out =
                amq_server_method_new_queue_declare_ok (
                    ...
                    queue_declare_ok_m->message_count,
                    queue_declare_ok_m->consumer_count);
            s_send_method_out (thread, 1,
                amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_BIND_OK))
    icl_stats_inc ("amq_server_agent_send_queue_bind_ok", &s_amq_server_agent_send_queue_bind_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_PURGE_OK))
    icl_stats_inc ("amq_server_agent_send_queue_purge_ok", &s_amq_server_agent_send_queue_purge_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_DELETE_OK))
    icl_stats_inc ("amq_server_agent_send_queue_delete_ok", &s_amq_server_agent_send_queue_delete_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
static int
action_send_queue_unbind_ok (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_QUEUE_UNBIND_OK))
    icl_stats_inc ("amq_server_agent_send_queue_unbind_ok", &s_amq_server_agent_send_queue_unbind_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        //  Check channel is OPEN
        assert (queue_unbind_ok_m->channel_nbr == 1);
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            amq_server_method_unlink (&tcb->method_out);
            tcb->method_out =
...
static int
action_send_basic_qos_ok (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_QOS_OK))
    icl_stats_inc ("amq_server_agent_send_basic_qos_ok", &s_amq_server_agent_send_basic_qos_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        //  Check channel is OPEN
        assert (basic_qos_ok_m->channel_nbr == 1);
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            amq_server_method_unlink (&tcb->method_out);
            tcb->method_out =
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_CONSUME_OK))
    icl_stats_inc ("amq_server_agent_send_basic_consume_ok", &s_amq_server_agent_send_basic_consume_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_CANCEL_OK))
    icl_stats_inc ("amq_server_agent_send_basic_cancel_ok", &s_amq_server_agent_send_basic_cancel_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
static int
action_send_basic_return (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_RETURN))
    icl_stats_inc ("amq_server_agent_send_basic_return", &s_amq_server_agent_send_basic_return_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        //  Check channel is OPEN
        assert (basic_return_m->channel_nbr == 1);
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            amq_server_method_unlink (&tcb->method_out);
            tcb->method_out =
                amq_server_method_new_basic_return (
                    basic_return_m->reply_code,
                    basic_return_m->reply_text,
                    basic_return_m->exchange,
                    basic_return_m->routing_key);
            tcb->method_out->content =
                amq_content_basic_link (
                    basic_return_m->content
                );
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_DELIVER))
    icl_stats_inc ("amq_server_agent_send_basic_deliver", &s_amq_server_agent_send_basic_deliver_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            tcb->method_out =
                amq_server_method_new_basic_deliver (
                    basic_deliver_m->consumer_tag,
                    basic_deliver_m->delivery_tag,
                    basic_deliver_m->redelivered,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_GET_OK))
    icl_stats_inc ("amq_server_agent_send_basic_get_ok", &s_amq_server_agent_send_basic_get_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            tcb->method_out =
                amq_server_method_new_basic_get_ok (
                    basic_get_ok_m->delivery_tag,
                    basic_get_ok_m->redelivered,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_BASIC_GET_EMPTY))
    icl_stats_inc ("amq_server_agent_send_basic_get_empty", &s_amq_server_agent_send_basic_get_empty_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_DIRECT_PUT_OK))
    icl_stats_inc ("amq_server_agent_send_direct_put_ok", &s_amq_server_agent_send_direct_put_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_DIRECT_GET_OK))
    icl_stats_inc ("amq_server_agent_send_direct_get_ok", &s_amq_server_agent_send_direct_get_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_OPEN_OK))
    icl_stats_inc ("amq_server_agent_send_connection_open_ok", &s_amq_server_agent_send_connection_open_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_connection_open_ok (NULL);
        s_send_method_out (thread, 0, amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_OPEN_OK))
    icl_stats_inc ("amq_server_agent_send_channel_open_ok", &s_amq_server_agent_send_channel_open_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out =
            amq_server_method_new_channel_open_ok (channel_id);
        s_send_method_out (thread, 1, amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_CLOSE_OK))
    icl_stats_inc ("amq_server_agent_send_channel_close_ok", &s_amq_server_agent_send_channel_close_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_channel_close_ok ();
        s_send_method_out (thread, 1, amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_PUSH_METHOD_TO_CLIENT))
    icl_stats_inc ("amq_server_agent_push_method_to_client", &s_amq_server_agent_push_method_to_client_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            amq_server_method_unlink (&tcb->method_out);
            tcb->method_out = amq_server_method_link (push_m->method);
            s_send_method_out (thread, 1, amq_broker->debug_log);
        }
        else
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CHANNEL_CLOSE))
    icl_stats_inc ("amq_server_agent_send_channel_close", &s_amq_server_agent_send_channel_close_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            //  Send the method
            amq_server_method_unlink (&tcb->method_out);
            tcb->method_out = amq_server_method_new_channel_close (
                channel_error_m->reply_code,
                channel_error_m->reply_text,
                channel_error_m->faulting_class_id,
                channel_error_m->faulting_method_id);
            ...
            s_connection_exception (thread,
                ...
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_CLOSE);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONTENT_HEADER))
    icl_stats_inc ("amq_server_agent_send_content_header", &s_amq_server_agent_send_content_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_out->content) {
            ...
            if (tcb->method_out->class_id == AMQ_SERVER_BASIC) {
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONTENT_BODY_FRAME))
    icl_stats_inc ("amq_server_agent_send_content_body_frame", &s_amq_server_agent_send_content_body_frame_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (payload) {
            ...
            amq_server_channel_earn (tcb->channel);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SHUT_DOWN_SLAVE_THREADS))
    icl_stats_inc ("amq_server_agent_shut_down_slave_threads", &s_amq_server_agent_shut_down_slave_threads_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_CLOSE))
    icl_stats_inc ("amq_server_agent_send_connection_close", &s_amq_server_agent_send_connection_close_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        smt_timer_request_delay (thread,
            amq_server_config_close_timeout (amq_server_config) * 1000 * 1000,
            close_timeout_event);
        //  Send connection close
        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_connection_close (
            tcb->connection->reply_code,
            tcb->connection->reply_text,
            tcb->connection->faulting_class_id,
            tcb->connection->faulting_method_id);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_CLOSE))
    icl_stats_inc ("amq_server_agent_execute_connection_close", &s_amq_server_agent_execute_connection_close_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_CONNECTION_CLOSE_OK))
    icl_stats_inc ("amq_server_agent_send_connection_close_ok", &s_amq_server_agent_send_connection_close_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_method_unlink (&tcb->method_out);
        tcb->method_out = amq_server_method_new_connection_close_ok ();
        s_send_method_out (thread, 0, amq_broker->debug_log);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_FLUSH_THE_CONNECTION))
    icl_stats_inc ("amq_server_agent_flush_the_connection", &s_amq_server_agent_flush_the_connection_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SOCKET_ERROR))
    icl_stats_inc ("amq_server_agent_report_socket_error", &s_amq_server_agent_report_socket_error_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_SOCKET_TIMEOUT))
    icl_stats_inc ("amq_server_agent_report_socket_timeout", &s_amq_server_agent_report_socket_timeout_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SEND_HEARTBEAT_FRAME))
    icl_stats_inc ("amq_server_agent_send_heartbeat_frame", &s_amq_server_agent_send_heartbeat_frame_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DELIVER_DIRECT_CONTENTS))
    icl_stats_inc ("amq_server_agent_deliver_direct_contents", &s_amq_server_agent_deliver_direct_contents_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (pending)
            ...
            content = amq_content_basic_wire_get (tcb->bucket_in, &offset, &options);
            while (content) {
                if (tcb->trace >= ASL_TRACE_LOW) {
                ...
                amq_lease_sink (tcb->lease, content, options);
                amq_content_basic_unlink (&content);
                content = amq_content_basic_wire_get (tcb->bucket_in, &offset, &options);
                icl_atomic_inc32 ((volatile qbyte *) &(amq_broker->direct_in));
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DIRECT_CONTENT))
    icl_stats_inc ("amq_server_agent_write_direct_content", &s_amq_server_agent_write_direct_content_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        icl_atomic_inc32 ((volatile qbyte *) &(amq_broker->direct_out));
        ...
        while (batch && rc == 0 && thread->reply_list->smt_method.list_next != &thread->reply_list->smt_method) {
            ...
            if (method->event == direct_out_m_event) {
                ...
                amq_content_basic_chrono_add (
                    ((amq_server_agent_direct_out_t *) method->data)->content);
                rc = amq_content_basic_wire_put (
                    ((amq_server_agent_direct_out_t *) method->data)->content, bucket, direct_out_m->options);
                if (rc == 0) {
                    ipr_meter_count (amq_broker->ometer);
                    icl_atomic_dec32 ((volatile qbyte *) &(tcb->lease->pending));
                    icl_atomic_inc32 ((volatile qbyte *) &(amq_broker->direct_out));
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WRITE_DIRECT_HEARTBEAT))
    icl_stats_inc ("amq_server_agent_write_direct_heartbeat", &s_amq_server_agent_write_direct_heartbeat_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_FRAME_HEADER))
    icl_stats_inc ("amq_server_agent_read_frame_header", &s_amq_server_agent_read_frame_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_READ_FRAME_PAYLOAD))
    icl_stats_inc ("amq_server_agent_read_frame_payload", &s_amq_server_agent_read_frame_payload_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_FRAME_FORMAT))
    icl_stats_inc ("amq_server_agent_check_frame_format", &s_amq_server_agent_check_frame_format_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DECODE_METHOD))
    icl_stats_inc ("amq_server_agent_decode_method", &s_amq_server_agent_decode_method_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->frame_header.type == ASL_FRAME_METHOD) {
            amq_server_method_unlink (&tcb->method_in);
            tcb->method_in = amq_server_method_decode (tcb->bucket_in, tcb->strerror);
            if (tcb->method_in) {
                if (tcb->trace >= ASL_TRACE_LOW)
                    amq_server_method_dump (tcb->method_in,
                    amq_broker->debug_log, "I: recv ");
            }
            else
                s_connection_abort (thread,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_METHOD_CLASS))
    icl_stats_inc ("amq_server_agent_check_method_class", &s_amq_server_agent_check_method_class_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        if (tcb->method_in->class_id == AMQ_SERVER_CONNECTION)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id == AMQ_SERVER_CHANNEL)
            smt_thread_set_next_event (thread, channel_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_SERVER_BASIC
        &&  tcb->method_in->method_id == AMQ_SERVER_BASIC_PUBLISH)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_CONNECTION_METHOD))
    icl_stats_inc ("amq_server_agent_check_connection_method", &s_amq_server_agent_check_connection_method_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_in->method_id == AMQ_SERVER_CONNECTION_START_OK)
            smt_thread_set_next_event (thread, connection_start_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CONNECTION_TUNE_OK)
            smt_thread_set_next_event (thread, connection_tune_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CONNECTION_OPEN)
            smt_thread_set_next_event (thread, connection_open_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CONNECTION_CLOSE)
            smt_thread_set_next_event (thread, connection_close_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CONNECTION_CLOSE_OK)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_CHANNEL_METHOD))
    icl_stats_inc ("amq_server_agent_check_channel_method", &s_amq_server_agent_check_channel_method_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->method_in->method_id == AMQ_SERVER_CHANNEL_OPEN)
            smt_thread_set_next_event (thread, channel_open_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CHANNEL_CLOSE)
            smt_thread_set_next_event (thread, channel_close_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CHANNEL_CLOSE_OK)
            smt_thread_set_next_event (thread, channel_close_ok_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CHANNEL_FLOW)
            smt_thread_set_next_event (thread, channel_flow_event);
        else
        if (tcb->method_in->method_id == AMQ_SERVER_CHANNEL_FLOW_OK)
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_FUNCTIONAL_METHOD))
    icl_stats_inc ("amq_server_agent_execute_functional_method", &s_amq_server_agent_execute_functional_method_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_START_OK))
    icl_stats_inc ("amq_server_agent_execute_connection_start_ok", &s_amq_server_agent_execute_connection_start_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_START_OK))
    icl_stats_inc ("amq_server_agent_notify_connection_of_start_ok", &s_amq_server_agent_notify_connection_of_start_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_agent_connection_start_ok (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_TUNE_OK))
    icl_stats_inc ("amq_server_agent_execute_connection_tune_ok", &s_amq_server_agent_execute_connection_tune_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        s_execute_method (thread, FALSE,
            AMQ_SERVER_CONNECTION, AMQ_SERVER_CONNECTION_TUNE_OK);
        tcb->frame_max = tcb->connection->frame_max;
        tcb->heartbeat = tcb->connection->heartbeat;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_TUNE_OK))
    icl_stats_inc ("amq_server_agent_notify_connection_of_tune_ok", &s_amq_server_agent_notify_connection_of_tune_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_agent_connection_tune_ok (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CONNECTION_OPEN))
    icl_stats_inc ("amq_server_agent_execute_connection_open", &s_amq_server_agent_execute_connection_open_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_OPEN))
    icl_stats_inc ("amq_server_agent_notify_connection_of_open", &s_amq_server_agent_notify_connection_of_open_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_agent_connection_open (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_PASSIVE_CLOSE))
    icl_stats_inc ("amq_server_agent_notify_connection_of_passive_close", &s_amq_server_agent_notify_connection_of_passive_close_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_CLOSE_OK))
    icl_stats_inc ("amq_server_agent_notify_connection_of_close_ok", &s_amq_server_agent_notify_connection_of_close_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        amq_server_agent_connection_close_ok (tcb->connection_thread);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_OPEN))
    icl_stats_inc ("amq_server_agent_execute_channel_open", &s_amq_server_agent_execute_channel_open_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_CLOSED) {
            //  Create the channel
            tcb->channel = amq_server_channel_new (
            ...
            s_execute_method (thread, TRUE,
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_OPEN);
            //  Queue the channel open ok
            if (!smt_thread_exception_raised (thread))
                amq_server_agent_send_channel_open_ok (tcb->connection_thread);
        }
        else
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_CLOSE))
    icl_stats_inc ("amq_server_agent_execute_channel_close", &s_amq_server_agent_execute_channel_close_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN) {
            ...
            if (!smt_thread_exception_raised (thread))
                amq_server_agent_send_channel_close_ok (tcb->connection_thread);
        }
        else
            //  Channel is not OPEN
            s_connection_exception (thread,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_CLOSE_OK))
    icl_stats_inc ("amq_server_agent_execute_channel_close_ok", &s_amq_server_agent_execute_channel_close_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_CLOSING) {
            ...
            s_connection_exception (thread,
                ...
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_CLOSE_OK);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_FLOW))
    icl_stats_inc ("amq_server_agent_execute_channel_flow", &s_amq_server_agent_execute_channel_flow_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN)
            s_execute_method (thread, TRUE,
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_FLOW);
        else
            s_connection_exception (thread,
                ASL_CHANNEL_ERROR, "Channel is not open",
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_FLOW);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXECUTE_CHANNEL_FLOW_OK))
    icl_stats_inc ("amq_server_agent_execute_channel_flow_ok", &s_amq_server_agent_execute_channel_flow_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->channel_state == ASL_CHANNEL_OPEN)
            s_execute_method (thread, TRUE,
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_FLOW_OK);
        else
            s_connection_exception (thread,
                ASL_CHANNEL_ERROR, "Channel is not open",
                AMQ_SERVER_CHANNEL, AMQ_SERVER_CHANNEL_FLOW_OK);
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONTENT_BASIC_HEADER))
    icl_stats_inc ("amq_server_agent_expect_content_basic_header", &s_amq_server_agent_expect_content_basic_header_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
        ...
        if (tcb->frame_header.type == ASL_FRAME_HEADER) {
            ...
            if (((amq_content_basic_t *)
                tcb->method_in->content)->class_id != AMQ_SERVER_BASIC)
                s_connection_exception (thread, ASL_SYNTAX_ERROR,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_IF_BASIC_BODY_COMPLETE))
    icl_stats_inc ("amq_server_agent_check_if_basic_body_complete", &s_amq_server_agent_check_if_basic_body_complete_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONTENT_BASIC_BODY))
    icl_stats_inc ("amq_server_agent_expect_content_basic_body", &s_amq_server_agent_expect_content_basic_body_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_EXCEPTION_METHOD))
    icl_stats_inc ("amq_server_agent_expect_exception_method", &s_amq_server_agent_expect_exception_method_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{

        if (tcb->method_in->class_id  == AMQ_SERVER_CONNECTION &&
            tcb->method_in->method_id == AMQ_SERVER_CONNECTION_CLOSE)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_SERVER_CONNECTION &&
            tcb->method_in->method_id == AMQ_SERVER_CONNECTION_CLOSE_OK)
            smt_thread_set_next_event (thread, connection_class_event);
        else
        if (tcb->method_in->class_id  == AMQ_SERVER_CHANNEL &&
            tcb->method_in->method_id == AMQ_SERVER_CHANNEL_CLOSE)
            smt_thread_set_next_event (thread, channel_class_event);
        else
            s_connection_exception (thread, ASL_SYNTAX_ERROR,
                "Method not allowed",
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_EXCEPTION))
    icl_stats_inc ("amq_server_agent_notify_connection_of_exception", &s_amq_server_agent_notify_connection_of_exception_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_NOTIFY_CONNECTION_OF_ERROR))
    icl_stats_inc ("amq_server_agent_notify_connection_of_error", &s_amq_server_agent_notify_connection_of_error_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_METHOD_FRAME))
    icl_stats_inc ("amq_server_agent_expect_method_frame", &s_amq_server_agent_expect_method_frame_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_EXPECT_CONNECTION_CLOSE_OK))
    icl_stats_inc ("amq_server_agent_expect_connection_close_ok", &s_amq_server_agent_expect_connection_close_ok_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_WAIT_FOR_HEARTBEAT_INTERVAL))
    icl_stats_inc ("amq_server_agent_wait_for_heartbeat_interval", &s_amq_server_agent_wait_for_heartbeat_interval_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_CHECK_PEER_LIVENESS))
    icl_stats_inc ("amq_server_agent_check_peer_liveness", &s_amq_server_agent_check_peer_liveness_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_PEER_SLOWING))
    icl_stats_inc ("amq_server_agent_report_peer_slowing", &s_amq_server_agent_report_peer_slowing_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_SHUT_DOWN_AGENT))
    icl_stats_inc ("amq_server_agent_shut_down_agent", &s_amq_server_agent_shut_down_agent_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_REPORT_PEER_STOPPED))
    icl_stats_inc ("amq_server_agent_report_peer_stopped", &s_amq_server_agent_report_peer_stopped_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_PASSIVE_CLOSE))
    icl_stats_inc ("amq_server_agent_dialog_call_close_the_connection_passive_close", &s_amq_server_agent_dialog_call_close_the_connection_passive_close_stats);
#endif        
    thread->module++;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_RETURN))
    icl_stats_inc ("amq_server_agent_dialog_return", &s_amq_server_agent_dialog_return_stats);
#endif        
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_29))
    icl_stats_inc ("amq_server_agent_unnamed_29", &s_amq_server_agent_unnamed_29_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_30))
    icl_stats_inc ("amq_server_agent_unnamed_30", &s_amq_server_agent_unnamed_30_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_31))
    icl_stats_inc ("amq_server_agent_unnamed_31", &s_amq_server_agent_unnamed_31_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_34))
    icl_stats_inc ("amq_server_agent_unnamed_34", &s_amq_server_agent_unnamed_34_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CLOSE_THE_CONNECTION_ACTIVE_CLOSE))
    icl_stats_inc ("amq_server_agent_dialog_call_close_the_connection_active_close", &s_amq_server_agent_dialog_call_close_the_connection_active_close_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_36))
    icl_stats_inc ("amq_server_agent_unnamed_36", &s_amq_server_agent_unnamed_36_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_SEND_CONTENT_BODY_IF_ANY_START))
    icl_stats_inc ("amq_server_agent_dialog_call_send_content_body_if_any_start", &s_amq_server_agent_dialog_call_send_content_body_if_any_start_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
static int
action_unnamed_60 (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_60))
    icl_stats_inc ("amq_server_agent_unnamed_60", &s_amq_server_agent_unnamed_60_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_70))
    icl_stats_inc ("amq_server_agent_unnamed_70", &s_amq_server_agent_unnamed_70_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_71))
    icl_stats_inc ("amq_server_agent_unnamed_71", &s_amq_server_agent_unnamed_71_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
static int
action_unnamed_72 (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_72))
    icl_stats_inc ("amq_server_agent_unnamed_72", &s_amq_server_agent_unnamed_72_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
static int
action_unnamed_73 (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_73))
    icl_stats_inc ("amq_server_agent_unnamed_73", &s_amq_server_agent_unnamed_73_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
static int
action_unnamed_74 (smt_thread_t *thread)
{
    int
        _rc = SMT_OK;

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_UNNAMED_74))
    icl_stats_inc ("amq_server_agent_unnamed_74", &s_amq_server_agent_unnamed_74_stats);
#endif        
#define tcb ((amq_server_agent_connection_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_READ_METHOD_READ_METHOD))
    icl_stats_inc ("amq_server_agent_dialog_call_read_method_read_method", &s_amq_server_agent_dialog_call_read_method_read_method_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_CONNECTION_CLOSING_CLOSING))
    icl_stats_inc ("amq_server_agent_dialog_call_connection_closing_closing", &s_amq_server_agent_dialog_call_connection_closing_closing_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT)  ||  defined (BASE_STATS_AMQ_SERVER_AGENT_DIALOG_CALL_READ_BASIC_CONTENT_HEADER))
    icl_stats_inc ("amq_server_agent_dialog_call_read_basic_content_header", &s_amq_server_agent_dialog_call_read_basic_content_header_stats);
#endif        
    thread->module++;
    smt_thread_position_push (thread);
    thread->module = 0;
