...
#define self_show_animation  amq_binding_mgt_show_animation
...
char *EMBED__amq_binding_mgt_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_binding_mgt_component    = "amq_binding_mgt ";
char *EMBED__amq_binding_mgt_version      = "1.0 ";
char *EMBED__amq_binding_mgt_copyright    = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_binding_mgt_filename     = "amq_binding_mgt.icl ";
char *EMBED__amq_binding_mgt_builddate    = "2010/10/06 ";
char *EMBED__amq_binding_mgt_version_end  = "VeRsIoNeNd:ipc";
