...
#define self_show_animation  amq_exchange_table_show_animation
...
if (self) {
    ...
    if (self->links == 0) {
        icl_system_panic ("amq_exchange_table", "E: missing link on amq_exchange_table object");
...
/*  -------------------------------------------------------------------------
    amq_exchange_table_show_animation
...
char *EMBED__amq_exchange_table_version_start  = "VeRsIoNsTaRt:ipc";
char *EMBED__amq_exchange_table_component  = "amq_exchange_table ";
char *EMBED__amq_exchange_table_version   = "1.0 ";
char *EMBED__amq_exchange_table_copyright  = "Copyright (c) 1996-2009 iMatix Corporation";
char *EMBED__amq_exchange_table_filename  = "amq_exchange_table.icl ";
char *EMBED__amq_exchange_table_builddate  = "2010/10/06 ";
char *EMBED__amq_exchange_table_version_end  = "VeRsIoNeNd:ipc";
