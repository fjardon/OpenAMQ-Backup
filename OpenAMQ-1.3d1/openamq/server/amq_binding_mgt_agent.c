/*---------------------------------------------------------------------------
    amq_binding_mgt_agent.c - functions for amq_binding_mgt_agent.

    Generated from amq_binding_mgt_agent.smt by smt_gen.gsl using GSL/4.
...
#define destroy_m ((amq_binding_mgt_agent_destroy_t *) thread->method->data)

#define inspect_m ((amq_binding_mgt_agent_inspect_t *) thread->method->data)

#define modify_m ((amq_binding_mgt_agent_modify_t *) thread->method->data)

#define method_m ((amq_binding_mgt_agent_method_t *) thread->method->data)
...
#define amq_binding_mgt_agent_agent_name           "Amq-Binding-Mgt-Agent"
...
amq_binding_mgt_agent_destroy_t;

typedef struct
  {
    amq_content_basic_t *  request;
  }
amq_binding_mgt_agent_inspect_t;
...
amq_binding_mgt_agent_modify_t;
...
amq_binding_mgt_agent_method_t;
...
} amq_binding_mgt_agent_class_context_t;
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_BINDING_MGT_AGENT)    ||  defined (BASE_TRACE)  || defined (BASE_TRACE_AMQ_BINDING_MGT_AGENT)   ||  defined (AMQ_BINDING_MGT_AGENT_TRACE))
...
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_BINDING_MGT_AGENT))
static Bool
    s_animate = FALSE;
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_DESTROY))
static icl_stats_t *s_amq_binding_mgt_agent_destroy_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_FREE))
static icl_stats_t *s_amq_binding_mgt_agent_free_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_3))
static icl_stats_t *s_amq_binding_mgt_agent_unnamed_3_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_4))
static icl_stats_t *s_amq_binding_mgt_agent_unnamed_4_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_INSPECT))
static icl_stats_t *s_amq_binding_mgt_agent_inspect_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_6))
static icl_stats_t *s_amq_binding_mgt_agent_unnamed_6_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_MODIFY))
static icl_stats_t *s_amq_binding_mgt_agent_modify_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_8))
static icl_stats_t *s_amq_binding_mgt_agent_unnamed_8_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_METHOD))
static icl_stats_t *s_amq_binding_mgt_agent_method_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_10))
static icl_stats_t *s_amq_binding_mgt_agent_unnamed_10_stats = NULL;
#endif
...
static int    amq_binding_mgt_agent_manager   (smt_thread_t **thread);
static int    amq_binding_mgt_agent_catcher   (smt_thread_t *thread);
static int    amq_binding_mgt_agent_class_destroy  (smt_thread_t *thread);
...
#endif
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_BINDING_MGT_AGENT)      ||  defined (AMQ_BINDING_MGT_AGENT_TRACE))
...
static int
amq_binding_mgt_agent_destroy_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    char *         file,
    size_t         line);
int
amq_binding_mgt_agent_destroy_destructor (void *data);
static int
amq_binding_mgt_agent_inspect_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    amq_content_basic_t *  request);
int
amq_binding_mgt_agent_inspect_destructor (void *data);
static int
amq_binding_mgt_agent_modify_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    amq_content_basic_t *  request,
    asl_field_list_t *  fields);
int
amq_binding_mgt_agent_modify_destructor (void *data);
static int
amq_binding_mgt_agent_method_send (
    smt_method_queue_t *_queue,
    smt_event_t        _event,
    char *         method_name,
    amq_content_basic_t *  request,
    asl_field_list_t *  fields);
int
amq_binding_mgt_agent_method_destructor (void *data);
    ...
    size_t         line)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          amq_binding_mgt_agent_destroy_destructor);
...
size_t line;
    ...
    file = ((amq_binding_mgt_agent_destroy_t *) data)-> file;
    line = ((amq_binding_mgt_agent_destroy_t *) data)-> line;
    ...
    amq_content_basic_t *  request)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_binding_mgt_agent_inspect_destructor);
...
amq_content_basic_t * request;
    ...
    request = ((amq_binding_mgt_agent_inspect_t *) data)-> request;
    ...
    asl_field_list_t *  fields)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_binding_mgt_agent_modify_destructor);
...
asl_field_list_t * fields;
    ...
    request = ((amq_binding_mgt_agent_modify_t *) data)-> request;
    fields = ((amq_binding_mgt_agent_modify_t *) data)-> fields;
    ...
    asl_field_list_t *  fields)
{
    ...
    rc = smt_method_send (_queue,           //  The queue
                          ...
                          SMT_OK,           //  Always OK
                          _message,         //  The message
                          amq_binding_mgt_agent_method_destructor);
...
asl_field_list_t * fields;
    ...
    method_name = ((amq_binding_mgt_agent_method_t *) data)-> method_name;
    request = ((amq_binding_mgt_agent_method_t *) data)-> request;
    fields = ((amq_binding_mgt_agent_method_t *) data)-> fields;
    ...
    size_t                line)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_binding_mgt_agent_manager);
        rc = amq_binding_mgt_agent_destroy_send (
    ...
    amq_content_basic_t * request)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_binding_mgt_agent_manager);
        rc = amq_binding_mgt_agent_inspect_send (
    ...
    asl_field_list_t *    fields)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_binding_mgt_agent_manager);
        rc = amq_binding_mgt_agent_modify_send (
    ...
    asl_field_list_t *    fields)
{
    ...
    if (thread && !thread->zombie) {
        assert (thread->manager == amq_binding_mgt_agent_manager);
        rc = amq_binding_mgt_agent_method_send (
...
void
amq_binding_mgt_agent_term (void)
{

}

int 
amq_binding_mgt_agent_init (void)
{
    int
        rc = SMT_OK;                    //  Return code

    s_class_context_cache = icl_cache_get (sizeof (amq_binding_mgt_agent_class_context_t));
    s_destroy_cache = icl_cache_get (sizeof (amq_binding_mgt_agent_destroy_t));
    s_inspect_cache = icl_cache_get (sizeof (amq_binding_mgt_agent_inspect_t));
    s_modify_cache = icl_cache_get (sizeof (amq_binding_mgt_agent_modify_t));
    s_method_cache = icl_cache_get (sizeof (amq_binding_mgt_agent_method_t));
    ...
    icl_system_register (NULL, amq_binding_mgt_agent_term);
    
    return rc;
}

void
amq_binding_mgt_agent_animate (Bool animate)
{
#if (defined (BASE_ANIMATE) || defined (BASE_ANIMATE_AMQ_BINDING_MGT_AGENT))
    s_animate = animate;
#endif
...
smt_thread_t *
amq_binding_mgt_agent_class_thread_new (
    amq_binding_mgt_t * self)
{
    smt_thread_t
        *thread;

    thread = smt_thread_new (amq_binding_mgt_agent_manager,
                             amq_binding_mgt_agent_catcher,
                             amq_binding_mgt_agent_class_destroy);
                             

#if (defined (AMQ_BINDING_MGT_AGENT_TRACE))
    ...
    if (thread) {
        ...
        if (s_animate)
            icl_console_print ("%4lu> %-15s/%-15s <Created>",
                thread->id,
                "amq_binding_mgt_agent",
                class_thread_name);
#endif

        thread->place   = 1;
        thread->context = icl_mem_cache_alloc (s_class_context_cache);
        memset (thread->context, 0, sizeof (amq_binding_mgt_agent_class_context_t));
        ((amq_binding_mgt_agent_class_context_t *) thread->context)->links = 1;
        thread->event_name = event_name;
{
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
...
static int
amq_binding_mgt_agent_manager (smt_thread_t **thread_p)
{
    smt_thread_t
        *thread = *thread_p;
...
#undef  tcb
            ...
            switch (thread->_next_event) {
                ...
                case shutdown_event:
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_BINDING_MGT_AGENT))
...
static int
amq_binding_mgt_agent_catcher (smt_thread_t *thread)
{
    return SMT_OK;
}
...
static int    
amq_binding_mgt_agent_class_destroy (smt_thread_t *thread)
{
#if (defined (BASE_TRACE) || defined (BASE_TRACE_AMQ_BINDING_MGT_AGENT))
...
#endif
    if (--((amq_binding_mgt_agent_class_context_t *) thread->context)->links == 0)
...
report_unrecognised_event_error (smt_thread_t *thread)
{
    ...
    icl_console_print ("amq_binding_mgt_agent: Unrecognised event '%s' in '%s' thread number: %u, state: %s",
                       event_name_or_number,
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_DESTROY))
    icl_stats_inc ("amq_binding_mgt_agent_destroy", &s_amq_binding_mgt_agent_destroy_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_FREE))
    icl_stats_inc ("amq_binding_mgt_agent_free", &s_amq_binding_mgt_agent_free_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_3))
    icl_stats_inc ("amq_binding_mgt_agent_unnamed_3", &s_amq_binding_mgt_agent_unnamed_3_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_4))
    icl_stats_inc ("amq_binding_mgt_agent_unnamed_4", &s_amq_binding_mgt_agent_unnamed_4_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_INSPECT))
    icl_stats_inc ("amq_binding_mgt_agent_inspect", &s_amq_binding_mgt_agent_inspect_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
icl_shortstr_fmt (field_value, "%d", amq_queue_list_count (self->binding->queue_list));
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_6))
    icl_stats_inc ("amq_binding_mgt_agent_unnamed_6", &s_amq_binding_mgt_agent_unnamed_6_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_MODIFY))
    icl_stats_inc ("amq_binding_mgt_agent_modify", &s_amq_binding_mgt_agent_modify_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_8))
    icl_stats_inc ("amq_binding_mgt_agent_unnamed_8", &s_amq_binding_mgt_agent_unnamed_8_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_METHOD))
    icl_stats_inc ("amq_binding_mgt_agent_method", &s_amq_binding_mgt_agent_method_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
...
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT)  ||  defined (BASE_STATS_AMQ_BINDING_MGT_AGENT_UNNAMED_10))
    icl_stats_inc ("amq_binding_mgt_agent_unnamed_10", &s_amq_binding_mgt_agent_unnamed_10_stats);
#endif        
#define tcb ((amq_binding_mgt_agent_class_context_t *) thread->context)
{
