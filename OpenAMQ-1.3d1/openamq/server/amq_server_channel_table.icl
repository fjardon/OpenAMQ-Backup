<?xml?>
<class
    name      = "amq_server_channel_table"
    comment   = "Implements the hash table container for amq_server_channel"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "amq_server_channel" />
    <option name = "childtype"  value = "amq_server_channel_t" />
...
<import class = "amq_server_channel" after = "1" />
