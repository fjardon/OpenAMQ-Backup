/*---------------------------------------------------------------------------
    amq_exchange_by_vhost.h - amq_exchange_by_vhost component
...
# ifndef INCLUDE_AMQ_EXCHANGE_BY_VHOST_SAFE
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_SAFE
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_ACTIVE
#   if !defined (ICL_IMPORT_HEADERS)
#       define ICL_IMPORT_AMQ_EXCHANGE_BY_VHOST_ROOT
...
typedef struct _amq_exchange_by_vhost_t amq_exchange_by_vhost_t;
#if defined (DEBUG) || defined (BASE_HISTORY) || defined (BASE_HISTORY_AMQ_EXCHANGE_BY_VHOST)
#    define AMQ_EXCHANGE_BY_VHOST_HISTORY_LENGTH 32
#endif

#define AMQ_EXCHANGE_BY_VHOST_ALIVE     0xFABB
#define AMQ_EXCHANGE_BY_VHOST_DEAD      0xDEAD

#define AMQ_EXCHANGE_BY_VHOST_ASSERT_SANE(self)\
{\
    if (!self) {\
        fprintf (stderr, "FATAL ERROR at %s:%u, in %s\n", __FILE__, __LINE__, ICL_ASSERT_SANE_FUNCTION);\
        fprintf (stderr, "Attempting to work with a NULL amq_exchange_by_vhost\n");\
        fprintf (stderr, "Please report this to openamq-dev@lists.openamq.org\n");\
        fflush (stderr);\
        abort ();\
    }\
    if (self->object_tag != AMQ_EXCHANGE_BY_VHOST_ALIVE) {\
        fprintf (stderr, "FATAL ERROR at %s:%u, in %s\n", __FILE__, __LINE__, ICL_ASSERT_SANE_FUNCTION);\
        fprintf (stderr, "amq_exchange_by_vhost at %p expected object_tag=0x%x, actual object_tag=0x%x\n", self, AMQ_EXCHANGE_BY_VHOST_ALIVE, self->object_tag);\
        amq_exchange_by_vhost_show (self, ICL_CALLBACK_DUMP, stderr);\
        fprintf (stderr, "Please report this to openamq-dev@lists.openamq.org\n");\
        fflush (stderr);\
        abort ();\
    }\
...
#   endif
#   undef INCLUDE_AMQ_EXCHANGE_BY_VHOST_ACTIVE
#   if defined (ICL_IMPORT_AMQ_EXCHANGE_BY_VHOST_ROOT)
...
# ifndef INCLUDE_AMQ_EXCHANGE_BY_VHOST_UNSAFE
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_UNSAFE
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_ACTIVE
...
extern Bool
    amq_exchange_by_vhost_animating;

//  Structure of the amq_exchange_by_vhost object

struct _amq_exchange_by_vhost_t {
    ...
    volatile qbyte
        history_last;
    char
        *history_file [AMQ_EXCHANGE_BY_VHOST_HISTORY_LENGTH];
    int
        history_line  [AMQ_EXCHANGE_BY_VHOST_HISTORY_LENGTH];
    char
        *history_type [AMQ_EXCHANGE_BY_VHOST_HISTORY_LENGTH];
    int
        history_links [AMQ_EXCHANGE_BY_VHOST_HISTORY_LENGTH];
#endif
    dbyte
...
#   endif
//  Method prototypes
#define amq_exchange_by_vhost_new()     amq_exchange_by_vhost_new_ (__FILE__, __LINE__)
...
#define amq_exchange_by_vhost_first(self)  amq_exchange_by_vhost_first_ (self, __FILE__, __LINE__)
amq_exchange_t *
...
#define amq_exchange_by_vhost_last(self)  amq_exchange_by_vhost_last_ (self, __FILE__, __LINE__)
amq_exchange_t *
...
#define amq_exchange_by_vhost_next(item)  amq_exchange_by_vhost_next_ (item, __FILE__, __LINE__)
amq_exchange_t *
...
#define amq_exchange_by_vhost_prev(item)  amq_exchange_by_vhost_prev_ (item, __FILE__, __LINE__)
amq_exchange_t *
...
#define amq_exchange_by_vhost_show(item,opcode,trace_file)  amq_exchange_by_vhost_show_ (item, opcode, trace_file, __FILE__, __LINE__)
void
...
#define amq_exchange_by_vhost_destroy(self)  amq_exchange_by_vhost_destroy_ (self, __FILE__, __LINE__)
void
...
#define amq_exchange_by_vhost_link(self)  amq_exchange_by_vhost_link_ (self, __FILE__, __LINE__)
amq_exchange_by_vhost_t *
...
#define amq_exchange_by_vhost_unlink(self)  amq_exchange_by_vhost_unlink_ (self, __FILE__, __LINE__)
void
...
#define amq_exchange_by_vhost_new_in_scope(self_p,_scope)  amq_exchange_by_vhost_new_in_scope_ (self_p, _scope, __FILE__, __LINE__)
void
...
# if !defined (INCLUDE_AMQ_EXCHANGE_BY_VHOST_INLINE)
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_INLINE
#   define INCLUDE_AMQ_EXCHANGE_BY_VHOST_ACTIVE
...
#   if defined (ICL_IMPORT_AMQ_EXCHANGE_BY_VHOST_ROOT)
#       undef ICL_IMPORT_HEADERS
#       undef ICL_IMPORT_AMQ_EXCHANGE_BY_VHOST_ROOT
#   endif
# endif
#endif
