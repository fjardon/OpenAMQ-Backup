<?xml?>
<class
    name      = "amq_server_connection_table"
    comment   = "Implements the hash table container for amq_server_connection"
    version   = "1.0"
    script    = "icl_gen"
    >
<doc>
...
<inherit class = "icl_hash_head" >
    ...
    <option name = "childname"  value = "amq_server_connection" />
    <option name = "childtype"  value = "amq_server_connection_t" />
...
<import class = "amq_server_connection" after = "1" />
