...
enum {
    ...
    start_m_event                                  = 7,
    stop_m_event                                   = 8,
    peer_connection_open_ok_m_event                = 9,
    peer_connection_close_m_event                  = 10,
    peer_channel_open_ok_m_event                   = 11,
    peer_basic_deliver_m_event                     = 12,
    peer_basic_return_m_event                      = 13,
};
        ...
        else
          {
            *state_id = 2;
            switch (thread->place) {
                ...
                case 20: *event_id = 5;   *nextstate_id = 2;   break;
                case 21: *event_id = 6;   *nextstate_id = 2;   break;
