<?xml?>
<!--
    *** GENERATED FROM amq_client_config.opf BY opf_gen USING GSL/4 ***
...
<method name = "set sequence_set" template = "function">
    <argument name = "sequence_set" type = "int" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "sequence_set" return = "sequence_set">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "sequence_set" type = "int" />
    //
    if (self)
...
<method name = "set sequence_check" template = "function">
    <argument name = "sequence_check" type = "int" />
    <inherit name = "wrlock" />
    <local>
    icl_shortstr_t
        strvalue;
...
<method name = "sequence_check" return = "sequence_check">
    <argument name = "self" type = "$(selftype) *">Reference to self</argument>
    <declare name = "sequence_check" type = "int" />
    //
    if (self)
