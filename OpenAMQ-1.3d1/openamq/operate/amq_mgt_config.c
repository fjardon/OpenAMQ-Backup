...
#define self_animate        amq_mgt_config_animate
#define self_new_in_scope   amq_mgt_config_new_in_scope

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_NEW))
static icl_stats_t *s_amq_mgt_config_new_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_DESTROY))
static icl_stats_t *s_amq_mgt_config_annihilate_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_LOAD))
static icl_stats_t *s_amq_mgt_config_load_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_CHILDREN))
static icl_stats_t *s_amq_mgt_config_print_children_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
static icl_stats_t *s_amq_mgt_config_print_properties_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_SUMMARY))
static icl_stats_t *s_amq_mgt_config_print_summary_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CMDLINE))
static icl_stats_t *s_amq_mgt_config_cmdline_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_SELFTEST))
static icl_stats_t *s_amq_mgt_config_selftest_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_TERMINATE))
static icl_stats_t *s_amq_mgt_config_terminate_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_SHOW))
static icl_stats_t *s_amq_mgt_config_show_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
static icl_stats_t *s_amq_mgt_config_destroy_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_ALLOC))
static icl_stats_t *s_amq_mgt_config_alloc_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_FREE))
static icl_stats_t *s_amq_mgt_config_free_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_INITIALISE))
static icl_stats_t *s_amq_mgt_config_cache_initialise_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_PURGE))
static icl_stats_t *s_amq_mgt_config_cache_purge_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_TERMINATE))
static icl_stats_t *s_amq_mgt_config_cache_terminate_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_ANIMATE))
static icl_stats_t *s_amq_mgt_config_animate_stats = NULL;
#endif
#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
static icl_stats_t *s_amq_mgt_config_new_in_scope_stats = NULL;
#endif
static void
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_NEW))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_new_start"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_NEW))
    icl_trace_record (NULL, amq_mgt_config_dump, 1);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_NEW))
    icl_stats_inc ("amq_mgt_config_new", &s_amq_mgt_config_new_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_NEW))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 1);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_NEW))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_new_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" file=\"%s\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_DESTROY))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_destroy_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_DESTROY))
    icl_trace_record (NULL, amq_mgt_config_dump, 2);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_DESTROY))
    icl_stats_inc ("amq_mgt_config_annihilate", &s_amq_mgt_config_annihilate_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_DESTROY))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 2);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_DESTROY))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_destroy_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_LOAD))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_load_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_LOAD))
    icl_trace_record (NULL, amq_mgt_config_dump, 3);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_LOAD))
    icl_stats_inc ("amq_mgt_config_load", &s_amq_mgt_config_load_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_LOAD))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 3);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_LOAD))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_load_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_CHILDREN))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_children_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_CHILDREN))
    icl_trace_record (NULL, amq_mgt_config_dump, 4);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_CHILDREN))
    icl_stats_inc ("amq_mgt_config_print_children", &s_amq_mgt_config_print_children_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_CHILDREN))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 4);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_CHILDREN))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_children_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_properties_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
    icl_trace_record (NULL, amq_mgt_config_dump, 5);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
    icl_stats_inc ("amq_mgt_config_print_properties", &s_amq_mgt_config_print_properties_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 5);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_PROPERTIES))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_properties_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_SUMMARY))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_summary_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_SUMMARY))
    icl_trace_record (NULL, amq_mgt_config_dump, 6);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_PRINT_SUMMARY))
    icl_stats_inc ("amq_mgt_config_print_summary", &s_amq_mgt_config_print_summary_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_PRINT_SUMMARY))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 6);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_PRINT_SUMMARY))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_print_summary_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CMDLINE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cmdline_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CMDLINE))
    icl_trace_record (NULL, amq_mgt_config_dump, 7);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CMDLINE))
    icl_stats_inc ("amq_mgt_config_cmdline", &s_amq_mgt_config_cmdline_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CMDLINE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 7);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CMDLINE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cmdline_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_SELFTEST))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_selftest_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_SELFTEST))
    icl_trace_record (NULL, amq_mgt_config_dump, 8);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_SELFTEST))
    icl_stats_inc ("amq_mgt_config_selftest", &s_amq_mgt_config_selftest_stats);
#endif

#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_SELFTEST))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 8);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_SELFTEST))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_selftest_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_TERMINATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_terminate_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_TERMINATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 9);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_TERMINATE))
    icl_stats_inc ("amq_mgt_config_terminate", &s_amq_mgt_config_terminate_stats);
#endif


#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_TERMINATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 9);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_TERMINATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_terminate_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_SHOW))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_show_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" item=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_SHOW))
    icl_trace_record (NULL, amq_mgt_config_dump, 10);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_SHOW))
    icl_stats_inc ("amq_mgt_config_show", &s_amq_mgt_config_show_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_SHOW))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 10);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_SHOW))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_show_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" item=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_destroy_public_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
    icl_trace_record (NULL, amq_mgt_config_dump, 11);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
    icl_stats_inc ("amq_mgt_config_destroy", &s_amq_mgt_config_destroy_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 11);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_DESTROY_PUBLIC))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_destroy_public_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_ALLOC))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_alloc_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" file=\"%s\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_ALLOC))
    icl_trace_record (NULL, amq_mgt_config_dump, 12);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_ALLOC))
    icl_stats_inc ("amq_mgt_config_alloc", &s_amq_mgt_config_alloc_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_ALLOC))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 12);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_ALLOC))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_alloc_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" file=\"%s\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_FREE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_free_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_FREE))
    icl_trace_record (NULL, amq_mgt_config_dump, 13);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_FREE))
    icl_stats_inc ("amq_mgt_config_free", &s_amq_mgt_config_free_stats);
#endif
...
//        memset (self, 0, sizeof (amq_mgt_config_t));
    ...
    self = NULL;
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_FREE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 13);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_FREE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_free_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self=\"%pp\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_INITIALISE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_initialise_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_INITIALISE))
    icl_trace_record (NULL, amq_mgt_config_dump, 14);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_INITIALISE))
    icl_stats_inc ("amq_mgt_config_cache_initialise", &s_amq_mgt_config_cache_initialise_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_INITIALISE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 14);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_INITIALISE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_initialise_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_PURGE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_purge_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_PURGE))
    icl_trace_record (NULL, amq_mgt_config_dump, 15);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_PURGE))
    icl_stats_inc ("amq_mgt_config_cache_purge", &s_amq_mgt_config_cache_purge_stats);
#endif

icl_mem_cache_purge (s_cache);

#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_PURGE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 15);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_PURGE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_purge_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_TERMINATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_terminate_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_TERMINATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 16);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_CACHE_TERMINATE))
    icl_stats_inc ("amq_mgt_config_cache_terminate", &s_amq_mgt_config_cache_terminate_stats);
#endif

s_cache = NULL;

#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_CACHE_TERMINATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 16);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_CACHE_TERMINATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_cache_terminate_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
"/>"
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_ANIMATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_animate_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" enabled=\"%i\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_ANIMATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 17);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_ANIMATE))
    icl_stats_inc ("amq_mgt_config_animate", &s_amq_mgt_config_animate_stats);
#endif

amq_mgt_config_animating = enabled;
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_ANIMATE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 17);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_ANIMATE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_animate_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" enabled=\"%i\""
...
#if (defined (BASE_ANIMATE)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG)  ||  defined (BASE_ANIMATE_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_new_in_scope_start"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self_p=\"%pp\""
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
    icl_trace_record (NULL, amq_mgt_config_dump, 18);
#endif

#if (defined (BASE_STATS)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG)  ||  defined (BASE_STATS_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
    icl_stats_inc ("amq_mgt_config_new_in_scope", &s_amq_mgt_config_new_in_scope_stats);
#endif
...
#if (defined (BASE_TRACE)   || defined (BASE_TRACE_AMQ_MGT_CONFIG)   || defined (BASE_TRACE_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
    icl_trace_record (NULL, amq_mgt_config_dump, 0x10000 + 18);
#endif

#if (defined (BASE_ANIMATE)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG)   || defined (BASE_ANIMATE_AMQ_MGT_CONFIG_NEW_IN_SCOPE))
    if (amq_mgt_config_animating)
        icl_console_print ("<amq_mgt_config_new_in_scope_finish"
#if (defined (BASE_THREADSAFE))
" thread=\"%pp\""
#endif
" self_p=\"%pp\""
...
char *amq_mgt_config_version_start  = "VeRsIoNsTaRt:ipc";
char *amq_mgt_config_component     = "amq_mgt_config ";
char *amq_mgt_config_version       = "1.0 ";
char *amq_mgt_config_copyright     = "Copyright (c) 1996-2009 iMatix Corporation";
char *amq_mgt_config_filename      = "amq_mgt_config.icl ";
char *amq_mgt_config_builddate     = "2010/10/06 ";
char *amq_mgt_config_version_end   = "VeRsIoNeNd:ipc";
