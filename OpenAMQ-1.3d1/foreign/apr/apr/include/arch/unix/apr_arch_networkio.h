...
/* Determine if we are going to use read buffering on sockets */
/* Only do so if apr_pollset_poll actually uses poll() */
#if defined (HAVE_POLL)
#if !defined (HAVE_KQUEUE) && !defined (HAVE_PORT_CREATE) && !defined (HAVE_EPOLL)
#define APR_SOCKET_BUFFER
#define APR_SOCKET_BUFFER_SIZE  8192
...
struct apr_socket_t {
    ...
    apr_ssize_t rbuf_size;
    apr_ssize_t rbuf_used;
    unsigned char *rbuf;
    unsigned char *rbuf_pos;
