...
#include "icl.h"
#include "ipr_http.h"                    //  Prototypes for functions

//  - Local functions ---------------------------------------------------------

static int    decode_hex              (const char **input, size_t outmax);
static size_t encode_meta_char        (char  *output,
                                       char   code,
                                       size_t outmax,
                                       Bool   html);

/*  ---------------------------------------------------------------------[<]-
    Function: ipr_http_encode_meta
...
/*  ---------------------------------------------------------------------[<]-
    Function: encode_meta_char -- internal
...
/*  ---------------------------------------------------------------------[<]-
    Function: ipr_http_decode_meta_charn
...
char
ipr_http_decode_meta_charn (const char *input, size_t length)
{
